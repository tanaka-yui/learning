import type { StoragePromptBlockType, StoragePromptBlockSnapshotType, StorageResolvedPromptBlockType, StorageCreatePromptBlockInput, StorageUpdatePromptBlockInput, StorageListPromptBlocksInput, StorageListPromptBlocksOutput, StorageListPromptBlocksResolvedOutput } from '../../types.js';
...
export declare abstract class PromptBlocksStorage extends VersionedStorageDomain<StoragePromptBlockType, StoragePromptBlockSnapshotType, StorageResolvedPromptBlockType, PromptBlockVersion, CreatePromptBlockVersionInput, ListPromptBlockVersionsInput, ListPromptBlockVersionsOutput, {
    promptBlock: StorageCreatePromptBlockInput;
}, StorageUpdatePromptBlockInput, StorageListPromptBlocksInput | undefined, StorageListPromptBlocksOutput, StorageListPromptBlocksResolvedOutput> {
    protected readonly listKey = "promptBlocks";
    protected readonly versionMetadataFields: ("id" | "createdAt" | "versionNumber" | "changedFields" | "changeMessage" | "blockId")[];
    constructor();
}
