...
var chunkEB6WWMRH_cjs = require('./chunk-EB6WWMRH.cjs');
...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunkEB6WWMRH_cjs.withoutTrailingSlash(
    (_a15 = options.baseURL) != null ? _a15 : "https://api.cerebras.ai/v1"
  );
  const getHeaders = () => chunkEB6WWMRH_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkEB6WWMRH_cjs.loadApiKey({
  ...
  const createLanguageModel = (modelId) => {
    return new chunkEB6WWMRH_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkEB6WWMRH_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunkEB6WWMRH_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkEB6WWMRH_cjs.postJsonToApi({
      url: `${this.config.baseURL}/${this.modelId}`,
      headers: chunkEB6WWMRH_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        prompt,
        num_images: n,
      ...
      failedResponseHandler: chunkEB6WWMRH_cjs.createJsonErrorResponseHandler({
        errorSchema: deepInfraErrorSchema,
        errorToMessage: (error) => error.detail.error
      }),
      successfulResponseHandler: chunkEB6WWMRH_cjs.createJsonResponseHandler(
...
var DeepInfraChatLanguageModel = class extends chunkEB6WWMRH_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunkEB6WWMRH_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunkEB6WWMRH_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunkEB6WWMRH_cjs.lazySchema(
  () => chunkEB6WWMRH_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
        created: v4.z.number().nullish(),
...
function prepareTools({
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new chunkEB6WWMRH_cjs.UnsupportedFunctionalityError({
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunkEB6WWMRH_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunkEB6WWMRH_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    } = await chunkEB6WWMRH_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkEB6WWMRH_cjs.combineHeaders(this.config.headers(), options.headers),
      body: args,
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkEB6WWMRH_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkEB6WWMRH_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: this.failedResponseHandler,
      successfulResponseHandler: chunkEB6WWMRH_cjs.createEventSourceResponseHandler(
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunkEB6WWMRH_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkEB6WWMRH_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkEB6WWMRH_cjs.generateId(),
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkEB6WWMRH_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkEB6WWMRH_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
            ...
            switch (part.type) {
              ...
              case "file": {
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkEB6WWMRH_cjs.convertToBase64(part.data)}`
                  }
                };
              }
            }
...
var groqFailedResponseHandler = chunkEB6WWMRH_cjs.createJsonErrorResponseHandler({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b;
    const warnings = [];
    const groqOptions = await chunkEB6WWMRH_cjs.parseProviderOptions({
      provider: "groq",
      providerOptions,
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkEB6WWMRH_cjs.postJsonToApi({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkEB6WWMRH_cjs.createEventSourceResponseHandler(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_i = toolCall2.function) == null ? void 0 : _i.name) != null && ((_j = toolCall2.function) == null ? void 0 : _j.arguments) != null) {
                    ...
                    if (chunkEB6WWMRH_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_k = toolCall2.id) != null ? _k : chunkEB6WWMRH_cjs.generateId(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_p = toolCall.function) == null ? void 0 : _p.name) != null && ((_q = toolCall.function) == null ? void 0 : _q.arguments) != null && chunkEB6WWMRH_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_r = toolCall.id) != null ? _r : chunkEB6WWMRH_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkEB6WWMRH_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkEB6WWMRH_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkEB6WWMRH_cjs.postFormDataToApi({
      url: this.config.url({
...
var browserSearch = chunkEB6WWMRH_cjs.createProviderDefinedToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkEB6WWMRH_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunkEB6WWMRH_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkEB6WWMRH_cjs.loadApiKey({
        apiKey: options.apiKey,
            ...
            switch (part.type) {
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkEB6WWMRH_cjs.convertToBase64(part.data)}`
                  };
...
var mistralFailedResponseHandler = chunkEB6WWMRH_cjs.createJsonErrorResponseHandler({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunkEB6WWMRH_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunkEB6WWMRH_cjs.parseProviderOptions({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunkEB6WWMRH_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
...
var MistralEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkEB6WWMRH_cjs.TooManyEmbeddingValuesForCallError({
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkEB6WWMRH_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunkEB6WWMRH_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkEB6WWMRH_cjs.loadApiKey({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunkEB6WWMRH_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunkEB6WWMRH_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
function createPerplexity(options = {}) {
  ...
  const createLanguageModel = (modelId) => {
    ...
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunkEB6WWMRH_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunkEB6WWMRH_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const createChatModel = (modelId) => {
    return new chunkEB6WWMRH_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
var xaiFailedResponseHandler = chunkEB6WWMRH_cjs.createJsonErrorResponseHandler({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunkEB6WWMRH_cjs.APICallError({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkEB6WWMRH_cjs.postJsonToApi({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunkEB6WWMRH_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunkEB6WWMRH_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunkEB6WWMRH_cjs.createEventSourceResponseHandler(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunkEB6WWMRH_cjs.convertToBase64(block.data)}`;
...
var webSearchArgsSchema = chunkEB6WWMRH_cjs.lazySchema(
  () => chunkEB6WWMRH_cjs.zodSchema(
    v4.z.object({
...
var webSearchOutputSchema = chunkEB6WWMRH_cjs.lazySchema(
  () => chunkEB6WWMRH_cjs.zodSchema(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunkEB6WWMRH_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.web_search",
  name: "web_search",
  inputSchema: chunkEB6WWMRH_cjs.lazySchema(() => chunkEB6WWMRH_cjs.zodSchema(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunkEB6WWMRH_cjs.lazySchema(
  () => chunkEB6WWMRH_cjs.zodSchema(
    v4.z.object({
...
var xSearchOutputSchema = chunkEB6WWMRH_cjs.lazySchema(
  () => chunkEB6WWMRH_cjs.zodSchema(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunkEB6WWMRH_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.x_search",
  name: "x_search",
  inputSchema: chunkEB6WWMRH_cjs.lazySchema(() => chunkEB6WWMRH_cjs.zodSchema(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider-defined") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunkEB6WWMRH_cjs.validateTypes({
            value: tool.args,
...
var codeExecutionToolFactory = chunkEB6WWMRH_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunkEB6WWMRH_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_image",
  name: "view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunkEB6WWMRH_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  name: "view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
function createXai(options = {}) {
  ...
  const createImageModel = (modelId) => {
    return new chunkEB6WWMRH_cjs.OpenAICompatibleImageModel(modelId, {
      provider: "xai.image",
      url: ({ path }) => `${baseURL}${path}`,
      headers: getHeaders,
      fetch: options.fetch,
...
var ModelsDevGateway = class extends chunkEB6WWMRH_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async fetchProviders() {
    ...
    for (const [providerId, providerInfo] of Object.entries(data)) {
      if (chunkEB6WWMRH_cjs.EXCLUDED_PROVIDERS.includes(providerId)) continue;
      ...
      const hasInstalledPackage = chunkEB6WWMRH_cjs.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
  ...
  async resolveLanguageModel({
    ...
    const mastraHeaders = { "User-Agent": chunkEB6WWMRH_cjs.MASTRA_USER_AGENT, ...headers };
    switch (providerId) {
      case "openai":
        return chunkEB6WWMRH_cjs.createOpenAI({ apiKey, headers: mastraHeaders }).responses(modelId);
      case "gemini":
      case "google":
        return chunkEB6WWMRH_cjs.createGoogleGenerativeAI({ apiKey, headers: mastraHeaders }).chat(modelId);
      case "anthropic":
        return chunkEB6WWMRH_cjs.createAnthropic({ apiKey, headers: mastraHeaders })(modelId);
      case "mistral":
      ...
      case "vercel":
        return chunkDP4YQ2HF_cjs.createGatewayProvider({ apiKey, headers: mastraHeaders })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunkEB6WWMRH_cjs.createAnthropic({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      }
      default: {
        const config = this.providerConfigs[providerId];
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkEB6WWMRH_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        if (npm === "@ai-sdk/google") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkEB6WWMRH_cjs.createGoogleGenerativeAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        ...
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunkEB6WWMRH_cjs.createOpenAICompatible({
          name: providerId,
          apiKey,
          baseURL,
...
//# sourceMappingURL=chunk-5JO4UOHA.cjs.map
//# sourceMappingURL=chunk-5JO4UOHA.cjs.map