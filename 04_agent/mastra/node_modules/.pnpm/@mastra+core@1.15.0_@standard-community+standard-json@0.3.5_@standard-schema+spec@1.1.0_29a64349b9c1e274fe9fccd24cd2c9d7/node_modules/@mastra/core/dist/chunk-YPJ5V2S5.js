import { isToolUIPart, convertToModelMessages } from './chunk-2PHG443D.js';
import { convertToCoreMessages } from './chunk-EB2EH2RY.js';
...
function sanitizeV5UIMessages(messages, filterIncompleteToolCalls = false) {
  const msgs = messages.map((m) => {
    if (m.parts.length === 0) return false;
    const hasOpenAIReasoning = filterIncompleteToolCalls && m.parts.some(
      (p) => p.type === "reasoning" && "providerMetadata" in p && p.providerMetadata && typeof p.providerMetadata === "object" && "openai" in p.providerMetadata
    );
...
//# sourceMappingURL=chunk-YPJ5V2S5.js.map
//# sourceMappingURL=chunk-YPJ5V2S5.js.map