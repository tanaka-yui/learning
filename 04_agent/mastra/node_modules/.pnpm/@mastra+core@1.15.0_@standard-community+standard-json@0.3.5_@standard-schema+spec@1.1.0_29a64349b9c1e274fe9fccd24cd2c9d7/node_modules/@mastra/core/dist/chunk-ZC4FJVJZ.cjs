...
// src/voice/voice.ts
var MastraVoice = class extends chunkRO47SMI7_cjs.MastraBase {
  listeningModel;
  speechModel;
  speaker;
  realtimeConfig;
...
var AISDKSpeech = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    const result = await chunkY3APFUXZ_cjs.generateSpeech({
      model: this.model,
      text,
...
var AISDKTranscription = class extends MastraVoice {
  ...
  async listen(audioStream, options) {
    ...
    const result = await chunkY3APFUXZ_cjs.transcribe({
      model: this.model,
      audio: audioBuffer,
      providerOptions: options?.providerOptions,
      abortSignal: options?.abortSignal,
...
//# sourceMappingURL=chunk-ZC4FJVJZ.cjs.map
//# sourceMappingURL=chunk-ZC4FJVJZ.cjs.map