...
// ../../node_modules/.pnpm/@ai-sdk+provider-utils@3.0.20_zod@4.3.6/node_modules/@ai-sdk/provider-utils/dist/index.mjs
var dist_exports = {};
...
function injectJsonInstructionIntoMessages({
  ...
  return [
    systemMessage,
    ...((_b15 = messages[0]) == null ? void 0 : _b15.role) === "system" ? messages.slice(1) : messages
  ];
}
...
function parseRecordDef(def, refs) {
  ...
  if (((_b15 = def.keyType) == null ? void 0 : _b15._def.typeName) === ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    image_url: {
                      ...
                      detail: (_b15 = (_a15 = part.providerOptions) == null ? void 0 : _a15.openai) == null ? void 0 : _b15.imageDetail
                    }
                  };
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    const structuredOutputs = (_b15 = openaiOptions.structuredOutputs) != null ? _b15 : true;
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a15, _b15, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      usage: {
        ...
        outputTokens: (_b15 = response.usage) == null ? void 0 : _b15.completion_tokens,
    ...
    switch (role) {
      ...
      case "assistant": {
        ...
        for (const part of content) {
          switch (part.type) {
            case "text": {
              const id = (_b15 = (_a15 = part.providerOptions) == null ? void 0 : _a15.openai) == null ? void 0 : _b15.itemId;
              if (store && id != null) {
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const strictJsonSchema = (_b15 = openaiOptions == null ? void 0 : openaiOptions.strictJsonSchema) != null ? _b15 : false;
  ...
  async doGenerate(options) {
    var _a15, _b15, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B;
    const {
      args: body,
      warnings,
      webSearchToolName
      ...
      switch (part.type) {
        ...
        case "message": {
          for (const contentPart of part.content) {
            if (((_c = (_b15 = options.providerOptions) == null ? void 0 : _b15.openai) == null ? void 0 : _c.logprobs) && contentPart.logprobs) {
              ...
              if (value.item.type === "message") {
                ...
                controller.enqueue({
                  ...
                  result: {
                    ...
                    results: (_c = (_b15 = value.item.results) == null ? void 0 : _b15.map((result) => ({
                      attributes: result.attributes,
                      fileId: result.file_id,
                      filename: result.filename,
                      score: result.score,
...
var OpenAITranscriptionModel = class {
  ...
  async doGenerate(options) {
    var _a15, _b15, _c, _d, _e, _f, _g, _h;
    const currentDate = (_c = (_b15 = (_a15 = this.config._internal) == null ? void 0 : _a15.currentDate) == null ? void 0 : _b15.call(_a15)) != null ? _c : /* @__PURE__ */ new Date();
...
function createOpenAI(options = {}) {
  ...
  const providerName = (_b15 = options.name) != null ? _b15 : "openai";
...
var MASTRA_USER_AGENT = `mastra/${"1.15.0"}` ;
                  ...
                  case "file": {
                    if (part.mediaType.startsWith("image/")) {
                      ...
                      anthropicContent.push({
                        ...
                        title: (_b15 = metadata.title) != null ? _b15 : part.filename,
...
var AnthropicMessagesLanguageModel = class {
  ...
  async getArgs({
    ...
    const { prompt: messagesPrompt, betas } = await convertToAnthropicMessagesPrompt({
      prompt,
      sendReasoning: (_b15 = anthropicOptions == null ? void 0 : anthropicOptions.sendReasoning) != null ? _b15 : true,
      warnings,
      cacheControlValidator
    });
  ...
  buildRequestUrl(isStreaming) {
    var _a15, _b15, _c;
    return (_c = (_b15 = (_a15 = this.config).buildRequestUrl) == null ? void 0 : _b15.call(_a15, this.config.baseURL, isStreaming)) != null ? _c : `${this.config.baseURL}/messages`;
  }
  transformRequestBody(args) {
    var _a15, _b15, _c;
    return (_c = (_b15 = (_a15 = this.config).transformRequestBody) == null ? void 0 : _b15.call(_a15, args)) != null ? _c : args;
  }
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      usage: {
        ...
        cachedInputTokens: (_b15 = response.usage.cache_read_input_tokens) != null ? _b15 : void 0
      },
      request: { body: args },
      response: {
  ...
  async doStream(options) {
    ...
    const transformedStream = response.pipeThrough(
      new TransformStream({
        ...
        transform(chunk, controller) {
          var _a22, _b22, _c, _d, _e, _f, _g, _h, _i, _j;
          if (options.includeRawChunks) {
            controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
          }
          if (!chunk.success) {
          ...
          switch (value.type) {
            ...
            case "message_start": {
              ...
              usage.cachedInputTokens = (_b22 = value.message.usage.cache_read_input_tokens) != null ? _b22 : void 0;
              rawUsage = {
                ...value.message.usage
              };
...
function createAnthropic(options = {}) {
  ...
  const providerName = (_b15 = options.name) != null ? _b15 : "anthropic.messages";
  const getHeaders = () => withUserAgentSuffix(
    {
      ...
      case "assistant": {
        ...
        contents.push({
          ...
          parts: content.map((part) => {
            var _a22, _b15, _c;
            const thoughtSignature = ((_b15 = (_a22 = part.providerOptions) == null ? void 0 : _a22.google) == null ? void 0 : _b15.thoughtSignature) != null ? String((_c = part.providerOptions.google) == null ? void 0 : _c.thoughtSignature) : void 0;
            switch (part.type) {
              case "text": {
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async doGenerate(options) {
    var _a15, _b15, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const mergedHeaders = combineHeaders(
      await resolve(this.config.headers),
    ...
    const content = [];
    const parts = (_b15 = (_a15 = candidate.content) == null ? void 0 : _a15.parts) != null ? _b15 : [];
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a15, _b15, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (usageMetadata != null) {
              ...
              usage.outputTokens = (_b15 = usageMetadata.candidatesTokenCount) != null ? _b15 : void 0;
    ...
    if (chunk.web != null) {
      ...
      if (uri && (uri.startsWith("http://") || uri.startsWith("https://"))) {
        sources.push({
          ...
          id: generateId3(),
          url: uri,
          title: (_b15 = chunk.retrievedContext.title) != null ? _b15 : void 0
        });
      } else if (uri) {
...
function createGoogleGenerativeAI(options = {}) {
  ...
  const providerName = (_b15 = options.name) != null ? _b15 : "google.generative-ai";
  const getHeaders = () => withUserAgentSuffix(
    {
...
export { AISDKError, APICallError, EXCLUDED_PROVIDERS, EmptyResponseBodyError, EventSourceParserStream, InvalidArgumentError, InvalidPromptError, InvalidResponseDataError, JSONParseError, LoadAPIKeyError, LoadSettingError, MASTRA_USER_AGENT, MastraModelGateway, NoSuchModelError, OpenAICompatibleChatLanguageModel, OpenAICompatibleCompletionLanguageModel, OpenAICompatibleEmbeddingModel, OpenAICompatibleImageModel, PROVIDERS_WITH_INSTALLED_PACKAGES, TooManyEmbeddingValuesForCallError, TypeValidationError, UnsupportedFunctionalityError, combineHeaders, convertBase64ToUint8Array, convertToBase64, convertUint8ArrayToBase64, createAnthropic, createEventSourceResponseHandler, createGoogleGenerativeAI, createJsonErrorResponseHandler, createJsonResponseHandler, createOpenAI, createOpenAICompatible, createProviderDefinedToolFactory, createProviderDefinedToolFactoryWithOutputSchema, dist_exports, extractResponseHeaders, generateId, injectJsonInstructionIntoMessages, isParsableJson, lazySchema, loadApiKey, mediaTypeToExtension, parseProviderOptions, postFormDataToApi, postJsonToApi, safeParseJSON, validateTypes, withUserAgentSuffix, withoutTrailingSlash, zodSchema };
//# sourceMappingURL=chunk-6JLJTBF7.js.map
//# sourceMappingURL=chunk-6JLJTBF7.js.map