...
function createSkillTool(skills) {
  const tool = chunkNQXA2BUF_cjs.createTool({
    id: "skill",
...
var astEditTool = chunkNQXA2BUF_cjs.createTool({
...
var deleteFileTool = chunkNQXA2BUF_cjs.createTool({
...
var editFileTool = chunkNQXA2BUF_cjs.createTool({
...
var executeCommandInputSchema = v4.z.object({
  ...
  timeout: v4.z.number().nullish().describe("Maximum execution time in seconds. Example: 60 for 1 minute."),
...
var executeCommandTool = chunkNQXA2BUF_cjs.createTool({
...
var executeCommandWithBackgroundTool = chunkNQXA2BUF_cjs.createTool({
  id: WORKSPACE_TOOLS.SANDBOX.EXECUTE_COMMAND,
  description: `${baseDescription}
...
var fileStatTool = chunkNQXA2BUF_cjs.createTool({
...
var getProcessOutputTool = chunkNQXA2BUF_cjs.createTool({
...
Use this after starting a background command with execute_command (background: true) to check if the process is still running and read its output.`,
  ...
  inputSchema: z.z.object({
    pid: z.z.string().describe("The process ID returned when the background command was started"),
...
var grepTool = chunkNQXA2BUF_cjs.createTool({
...
var indexContentTool = chunkNQXA2BUF_cjs.createTool({
...
var killProcessTool = chunkNQXA2BUF_cjs.createTool({
...
Use this to stop a long-running background process that was started with execute_command (background: true). Returns the last ${KILL_TAIL_LINES} lines of output.`,
  toModelOutput: sandboxToModelOutput,
  inputSchema: z.z.object({
    pid: z.z.string().describe("The process ID of the background process to kill")
  }),
...
var listFilesTool = chunkNQXA2BUF_cjs.createTool({
...
var mkdirTool = chunkNQXA2BUF_cjs.createTool({
...
var readFileTool = chunkNQXA2BUF_cjs.createTool({
...
var searchTool = chunkNQXA2BUF_cjs.createTool({
...
var writeFileTool = chunkNQXA2BUF_cjs.createTool({
