...
// src/server/auth.ts
var MastraAuthProvider = class extends chunkRO47SMI7_cjs.MastraBase {
  protected;
  public;
  constructor(options) {
...
// src/server/base.ts
var MastraServerBase = class extends chunkRO47SMI7_cjs.MastraBase {
  #app;
  constructor({ app, name }) {
    super({ component: chunk7XAECHYL_cjs.RegisteredLogger.SERVER, name: name ?? "Server" });
    this.#app = app;
