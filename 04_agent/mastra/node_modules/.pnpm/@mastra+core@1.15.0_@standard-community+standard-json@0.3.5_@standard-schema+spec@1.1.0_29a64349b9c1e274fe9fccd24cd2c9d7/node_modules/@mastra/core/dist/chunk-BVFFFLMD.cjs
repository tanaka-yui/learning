...
function isToolLoopAgentLike(obj) {
  if (!obj) return false;
  if (obj instanceof chunkDP4YQ2HF_cjs.ToolLoopAgent) return true;
  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkP2PWEGRW_cjs.resolveModelConfig(currentResult.model);
        if (!chunkBXSSIONK_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunkBXSSIONK_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-BVFFFLMD.cjs.map
//# sourceMappingURL=chunk-BVFFFLMD.cjs.map