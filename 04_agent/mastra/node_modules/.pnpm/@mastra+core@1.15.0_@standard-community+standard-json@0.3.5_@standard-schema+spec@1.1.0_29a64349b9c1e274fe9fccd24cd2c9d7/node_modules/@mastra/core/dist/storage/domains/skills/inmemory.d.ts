import type { StorageSkillType, StorageCreateSkillInput, StorageUpdateSkillInput, StorageListSkillsInput, StorageListSkillsOutput } from '../../types.js';
import type { InMemoryDB } from '../inmemory-db.js';
import type { SkillVersion, CreateSkillVersionInput, ListSkillVersionsInput, ListSkillVersionsOutput } from './base.js';
import { SkillsStorage } from './base.js';
export declare class InMemorySkillsStorage extends SkillsStorage {
    private db;
    constructor({ db }: {
        db: InMemoryDB;
    });
