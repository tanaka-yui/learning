import type { AnyExportedSpan, MetricEvent, LogEvent, ScoreEvent, FeedbackEvent } from '../../../observability/index.js';
...
export declare function toEntityType(value: string | undefined | null): EntityType | null;
/** Extract a string from an unknown value, returning null if not a string. */
export declare function getStringOrNull(value: unknown): string | null;
/** Extract a plain object from an unknown value, returning null if not an object. */
export declare function getObjectOrNull(value: unknown): Record<string, any> | null;
/**
 * Serializes span attributes to a plain JSON-safe object.
 * Handles Date objects and nested structures.
 */
export declare function serializeSpanAttributes(span: AnyExportedSpan): Record<string, any> | null;
/** Convert an exported span to a CreateSpanRecord */
export declare function buildCreateSpanRecord(span: AnyExportedSpan): CreateSpanRecord;
/** Convert an exported span to a partial UpdateSpanRecord */
export declare function buildUpdateSpanRecord(span: AnyExportedSpan): Partial<UpdateSpanRecord>;
/**
 * Convert a MetricEvent to a CreateMetricRecord,
 * extracting entity hierarchy from labels to first-class columns.
 */
export declare function buildMetricRecord(event: MetricEvent): CreateMetricRecord;
/** Convert a LogEvent to a CreateLogRecord */
export declare function buildLogRecord(event: LogEvent): CreateLogRecord;
/** Convert a ScoreEvent to a CreateScoreRecord */
export declare function buildScoreRecord(event: ScoreEvent): CreateScoreRecord;
/** Convert a FeedbackEvent to a CreateFeedbackRecord */
export declare function buildFeedbackRecord(event: FeedbackEvent): CreateFeedbackRecord;
