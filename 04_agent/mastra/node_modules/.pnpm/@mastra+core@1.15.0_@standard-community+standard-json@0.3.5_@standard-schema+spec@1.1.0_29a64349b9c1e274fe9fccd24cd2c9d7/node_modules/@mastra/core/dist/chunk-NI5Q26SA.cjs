...
var NetlifyGateway = class extends chunkEB6WWMRH_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunkEB6WWMRH_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
        return chunkEB6WWMRH_cjs.createGoogleGenerativeAI({
      ...
      case "anthropic":
        return chunkEB6WWMRH_cjs.createAnthropic({
          apiKey,
          baseURL: `${baseURL}/v1/`,
          headers: {
...
//# sourceMappingURL=chunk-NI5Q26SA.cjs.map
//# sourceMappingURL=chunk-NI5Q26SA.cjs.map