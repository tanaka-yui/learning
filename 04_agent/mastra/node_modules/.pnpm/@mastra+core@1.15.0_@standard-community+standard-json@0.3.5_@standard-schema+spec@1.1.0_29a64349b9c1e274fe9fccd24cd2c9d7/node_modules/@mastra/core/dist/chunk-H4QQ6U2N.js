import { ModelsDevGateway, parseModelRouterId } from './chunk-3A2WQ6XL.js';
import { NetlifyGateway } from './chunk-WAPASC33.js';
import { EventSourceParserStream, AISDKError, InvalidArgumentError, APICallError, LoadAPIKeyError, LoadSettingError, TypeValidationError, JSONParseError, EmptyResponseBodyError, MastraModelGateway, createOpenAICompatible, createOpenAI, createGoogleGenerativeAI, InvalidResponseDataError, UnsupportedFunctionalityError, MASTRA_USER_AGENT, TooManyEmbeddingValuesForCallError, InvalidPromptError } from './chunk-6JLJTBF7.js';
import { PROVIDER_REGISTRY, GatewayRegistry } from './chunk-RTQZRDV7.js';
import { AISDKV5LanguageModel, createStreamFromGenerateResult } from './chunk-EYLPPZIF.js';
...
function remapToolsToV3(options) {
  ...
  const remappedTools = options.tools.map((tool2) => {
    if (tool2.type === "provider-defined") {
      return { ...tool2, type: "provider" };
    }
    return tool2;
  });
  return {
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    const structuredOutputs = (_b2 = openaiOptions.structuredOutputs) != null ? _b2 : true;
  ...
  async doGenerate(options) {
    ...
    for (const toolCall of (_a2 = choice.message.tool_calls) != null ? _a2 : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b2 = toolCall.id) != null ? _b2 : generateId(),
        ...
        new TransformStream({
          ...
          transform(chunk, controller) {
            ...
            if (value.usage != null) {
              ...
              usage.outputTokens = (_b2 = value.usage.completion_tokens) != null ? _b2 : void 0;
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      usage: {
        ...
        outputTokens: (_b2 = response.usage) == null ? void 0 : _b2.completion_tokens,
    ...
    switch (role) {
      ...
      case "assistant": {
        ...
        for (const part of content) {
          switch (part.type) {
            case "text": {
              const id = (_b2 = (_a2 = part.providerOptions) == null ? void 0 : _a2.openai) == null ? void 0 : _b2.itemId;
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const strictJsonSchema = (_b2 = openaiOptions == null ? void 0 : openaiOptions.strictJsonSchema) != null ? _b2 : false;
      ...
      switch (part.type) {
        ...
        case "message": {
          for (const contentPart of part.content) {
            if (((_c = (_b2 = options.providerOptions) == null ? void 0 : _b2.openai) == null ? void 0 : _c.logprobs) && contentPart.logprobs) {
              ...
              if (value.item.type === "function_call") {
                ...
                controller.enqueue({
                  ...
                  providerMetadata: {
                    [providerKey]: {
                      itemId: value.item.id,
                      reasoningEncryptedContent: (_b2 = value.item.encrypted_content) != null ? _b2 : null
                    }
                  }
                });
              }
...
// ../../node_modules/.pnpm/@ai-sdk+azure@2.0.102_zod@4.3.6/node_modules/@ai-sdk/azure/dist/index.mjs
...
function createAzure(options = {}) {
  ...
  const apiVersion = (_a2 = options.apiVersion) != null ? _a2 : "v1";
...
function getStaticProvidersByGateway(name2) {
  return Object.fromEntries(Object.entries(PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name2));
}
...
//# sourceMappingURL=chunk-H4QQ6U2N.js.map
//# sourceMappingURL=chunk-H4QQ6U2N.js.map