...
var provider_registry_default = {
  providers: {
    ...
    inception: {
      ...
      apiKeyHeader: "Authorization",
      name: "Inception",
      models: ["mercury", "mercury-2", "mercury-coder", "mercury-edit"],
    ...
    "opencode-go": {
      ...
      apiKeyHeader: "Authorization",
      name: "OpenCode Go",
      models: ["glm-5", "kimi-k2.5", "minimax-m2.5", "minimax-m2.7"],
      docUrl: "https://opencode.ai/docs/zen",
      gateway: "models.dev"
    },
    drun: {
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-XIQD3JK4.cjs', document.baseURI).href)) || "file://");
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway } = await import('./models-dev-U7CZOMQF.cjs');
      const { NetlifyGateway } = await import('./netlify-GCMZMVMD.cjs');
...
//# sourceMappingURL=chunk-XIQD3JK4.cjs.map
//# sourceMappingURL=chunk-XIQD3JK4.cjs.map