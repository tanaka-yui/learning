import type { StorageAgentType, StorageAgentSnapshotType, StorageResolvedAgentType, StorageCreateAgentInput, StorageUpdateAgentInput, StorageListAgentsInput, StorageListAgentsOutput, StorageListAgentsResolvedOutput } from '../../types.js';
...
export declare abstract class AgentsStorage extends VersionedStorageDomain<StorageAgentType, StorageAgentSnapshotType, StorageResolvedAgentType, AgentVersion, CreateVersionInput, ListVersionsInput, ListVersionsOutput, {
    agent: StorageCreateAgentInput;
}, StorageUpdateAgentInput, StorageListAgentsInput | undefined, StorageListAgentsOutput, StorageListAgentsResolvedOutput> {
    protected readonly listKey = "agents";
    protected readonly versionMetadataFields: ("id" | "createdAt" | "agentId" | "versionNumber" | "changedFields" | "changeMessage")[];
    constructor();
}
