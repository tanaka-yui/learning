import type { StorageMCPClientType, StorageMCPClientSnapshotType, StorageResolvedMCPClientType, StorageCreateMCPClientInput, StorageUpdateMCPClientInput, StorageListMCPClientsInput, StorageListMCPClientsOutput, StorageListMCPClientsResolvedOutput } from '../../types.js';
...
export declare abstract class MCPClientsStorage extends VersionedStorageDomain<StorageMCPClientType, StorageMCPClientSnapshotType, StorageResolvedMCPClientType, MCPClientVersion, CreateMCPClientVersionInput, ListMCPClientVersionsInput, ListMCPClientVersionsOutput, {
    mcpClient: StorageCreateMCPClientInput;
}, StorageUpdateMCPClientInput, StorageListMCPClientsInput | undefined, StorageListMCPClientsOutput, StorageListMCPClientsResolvedOutput> {
    protected readonly listKey = "mcpClients";
    protected readonly versionMetadataFields: ("id" | "createdAt" | "versionNumber" | "changedFields" | "changeMessage" | "mcpClientId")[];
    constructor();
}
