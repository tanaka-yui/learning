...
var chunkVSGRSX3N_cjs = require('./chunk-VSGRSX3N.cjs');
...
var chunkP2PWEGRW_cjs = require('./chunk-P2PWEGRW.cjs');
var chunkFYQXIWRH_cjs = require('./chunk-FYQXIWRH.cjs');
var chunk6BJ7XHRH_cjs = require('./chunk-6BJ7XHRH.cjs');
var chunkOQDRPRKM_cjs = require('./chunk-OQDRPRKM.cjs');
var chunkYVFFNB2F_cjs = require('./chunk-YVFFNB2F.cjs');
...
function prepareToolsAndToolChoice({
  ...
  return {
    tools: filteredTools.map(([name, tool2]) => {
      try {
        if (chunkNQXA2BUF_cjs.isProviderDefinedTool(tool2)) {
          return {
            type: providerToolType,
            name: chunkNQXA2BUF_cjs.getProviderToolName(tool2.id),
            id: tool2.id,
            args: tool2.args ?? {}
          };
        }
        ...
        const sdkTool = chunkCFMZZDO2_cjs.tool({
          type: "function",
          ...tool2,
          inputSchema
        });
        ...
        switch (toolType) {
          ...
          case "function":
            ...
            if (sdkTool.inputSchema) {
              ...
              } else if (chunkVWJ7H3MJ_cjs.isStandardSchemaWithJSON(sdkTool.inputSchema)) {
                parameters = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(sdkTool.inputSchema, {
                  io: "input",
                  target: "draft-07"
                });
              } else {
                parameters = chunkCFMZZDO2_cjs.asSchema(sdkTool.inputSchema).jsonSchema;
              }
          ...
          case "provider-defined": {
            ...
            return {
              type: providerToolType,
              name: providerId ? chunkNQXA2BUF_cjs.getProviderToolName(providerId) : name,
              id: providerId,
              args: sdkTool.args
            };
          }
...
var StructuredOutputProcessor = class {
  ...
  async processOutputStream(args) {
    ...
    const observabilityContext = chunkJUL4UHWQ_cjs.resolveObservabilityContext(rest);
...
var ProcessorState = class {
  ...
  constructor(options) {
    ...
    this.span = parentSpan?.createChildSpan({
      ...
      entityType: chunkJUL4UHWQ_cjs.EntityType.OUTPUT_PROCESSOR,
...
var ProcessorRunner = class _ProcessorRunner {
    ...
    for (const [index, processorOrWorkflow] of this.outputProcessors.entries()) {
      ...
      try {
        ...
        const processResult = await processMethod({
          ...
          abort,
          ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: processorSpan }),
          requestContext,
          retryCount,
          writer
        });
        const mutations = messageList.stopRecording();
        if (processResult instanceof chunkO6O5MD7Q_cjs.MessageList) {
        ...
        try {
          if (processor.processOutputStream && processedPart) {
            ...
            const result = await processor.processOutputStream({
              ...
              ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: state.span }),
              requestContext,
              messageList,
              retryCount,
              writer
  ...
  async runInputProcessors(messageList, observabilityContext, requestContext, retryCount = 0) {
    for (const [index, processorOrWorkflow] of this.inputProcessors.entries()) {
      ...
      const processorSpan = parentSpan?.createChildSpan({
        ...
        entityType: chunkJUL4UHWQ_cjs.EntityType.INPUT_PROCESSOR,
        entityId: processor.id,
        entityName: processor.name,
        attributes: {
          processorExecutor: "legacy",
      ...
      try {
        ...
        let mutations;
        if (result instanceof chunkO6O5MD7Q_cjs.MessageList) {
  ...
  async runProcessInputStep(args) {
    ...
    const observabilityContext = chunkJUL4UHWQ_cjs.resolveObservabilityContext(args);
    const stepInput = {
    ...
    for (const [index, processorOrWorkflow] of processors.entries()) {
      ...
      const processorSpan = currentSpan?.createChildSpan({
        ...
        entityType: chunkJUL4UHWQ_cjs.EntityType.INPUT_STEP_PROCESSOR,
        entityId: processor.id,
        entityName: processor.name,
        attributes: {
          processorExecutor: "legacy",
  ...
  async runProcessOutputStep(args) {
    ...
    for (const [index, processorOrWorkflow] of this.outputProcessors.entries()) {
      ...
      const processorSpan = parentSpan?.createChildSpan({
        ...
        entityType: chunkJUL4UHWQ_cjs.EntityType.OUTPUT_STEP_PROCESSOR,
        entityId: processor.id,
        entityName: processor.name,
        attributes: {
          processorExecutor: "legacy",
  ...
  static async validateAndFormatProcessInputStepResult(result, {
    ...
    if (result instanceof chunkO6O5MD7Q_cjs.MessageList) {
      ...
      if (result.model) {
        const resolvedModel = await chunkP2PWEGRW_cjs.resolveModelConfig(result.model);
...
function asJsonSchema(schema) {
  ...
  if (chunkVWJ7H3MJ_cjs.isStandardSchemaWithJSON(schema)) {
    const jsonSchema = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(schema, { io: "input", target: "draft-07" });
    return jsonSchema;
  }
  return schema;
}
...
var ObjectFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const { value: currentObjectJson, state } = await chunkY3APFUXZ_cjs.parsePartialJson(processedAccumulatedText);
    if (this.validatePartialChunks && this.partialSchema) {
      const result = this.partialSchema?.safeParse(currentObjectJson);
      if (result.success && result.data && result.data !== void 0 && !chunkY3APFUXZ_cjs.isDeepEqualData(previousObject, result.data)) {
        return {
          shouldEmit: true,
    ...
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !chunkY3APFUXZ_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      return {
  ...
  async validateAndTransformFinal(finalRawValue) {
    ...
    const { value } = await chunkY3APFUXZ_cjs.parsePartialJson(rawValue);
...
var ArrayFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson, state: parseState } = await chunkY3APFUXZ_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && !chunkY3APFUXZ_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      ...
      if (!chunkY3APFUXZ_cjs.isDeepEqualData(this.textPreviousFilteredArray, filteredElements)) {
...
var EnumFormatHandler = class extends BaseFormatHandler {
  ...
  findBestEnumMatch(partialResult) {
    ...
    const outputJsonSchema = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(this.schema);
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson } = await chunkY3APFUXZ_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !Array.isArray(currentObjectJson) && "result" in currentObjectJson && typeof currentObjectJson.result === "string" && !chunkY3APFUXZ_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
  ...
  async validateAndTransformFinal(rawFinalValue) {
    ...
    const { value } = await chunkY3APFUXZ_cjs.parsePartialJson(processedValue);
...
function createOutputHandler({ schema }) {
  const normalizedSchema = schema && !chunkVWJ7H3MJ_cjs.isStandardSchemaWithJSON(schema) ? chunkVWJ7H3MJ_cjs.toStandardSchema(schema) : schema;
...
var MastraModelOutput = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor({
    ...
    const resultSpan = chunkJUL4UHWQ_cjs.getRootExportSpan(options.tracingContext?.currentSpan);
          ...
          async transform(chunk, controller) {
            if (chunk.type === "finish" && chunk.payload?.stepResult?.reason === "tool-calls") {
              ...
              const {
                ...
                chunk,
                processorStates,
                chunkJUL4UHWQ_cjs.resolveObservabilityContext(options),
            ...
            case "finish":
              ...
              try {
                if (self.processorRunner && !self.#options.isLLMExecutionStep) {
                  ...
                  const outputText = lastResponseMessage ? chunkO6O5MD7Q_cjs.coreContentToString(lastResponseMessage.content) : "";
  ...
  switch (chunk.type) {
    ...
    case "file":
      if (mode === "generate") {
        return {
          type: "file",
          file: new chunkO6O5MD7Q_cjs.DefaultGeneratedFile({
      ...
      return {
        type: "file",
        file: new chunkO6O5MD7Q_cjs.DefaultGeneratedFileWithType({
          data: chunk.payload.data,
          mediaType: chunk.payload.mimeType
        })
      };
...
var TextPartSchema = z9.z.object({
  type: z9.z.literal("text"),
  text: z9.z.string()
}).passthrough();
var ImagePartSchema = z9.z.object({
  type: z9.z.literal("image"),
  image: z9.z.union([z9.z.string(), z9.z.instanceof(URL), z9.z.instanceof(Uint8Array)]),
  mimeType: z9.z.string().optional()
}).passthrough();
var FilePartSchema = z9.z.object({
  type: z9.z.literal("file"),
  data: z9.z.union([z9.z.string(), z9.z.instanceof(URL), z9.z.instanceof(Uint8Array)]),
  mimeType: z9.z.string()
}).passthrough();
var ToolInvocationPartSchema = z9.z.object({
  type: z9.z.literal("tool-invocation"),
  toolInvocation: z9.z.object({
    toolCallId: z9.z.string(),
    toolName: z9.z.string(),
    args: z9.z.unknown(),
    state: z9.z.enum(["partial-call", "call", "result"]),
    result: z9.z.unknown().optional()
  })
}).passthrough();
var ReasoningPartSchema = z9.z.object({
  type: z9.z.literal("reasoning"),
  reasoning: z9.z.string(),
  details: z9.z.array(
    z9.z.object({
      type: z9.z.enum(["text", "redacted"]),
      text: z9.z.string().optional(),
      data: z9.z.string().optional()
    })
  )
}).passthrough();
var SourcePartSchema = z9.z.object({
  type: z9.z.literal("source"),
  source: z9.z.object({
    sourceType: z9.z.string(),
    id: z9.z.string(),
    url: z9.z.string().optional(),
    title: z9.z.string().optional()
  })
}).passthrough();
var StepStartPartSchema = z9.z.object({
  type: z9.z.literal("step-start")
}).passthrough();
var DataPartSchema = z9.z.object({
  type: z9.z.string().refine((t) => t.startsWith("data-"), { message: 'Type must start with "data-"' }),
  id: z9.z.string().optional(),
  data: z9.z.unknown()
}).passthrough();
var MessagePartSchema = z9.z.union([
  TextPartSchema,
  ImagePartSchema,
  FilePartSchema,
...
var MessageContentSchema = z9.z.object({
  /** Format version - 2 corresponds to AI SDK v4 UIMessage format */
  format: z9.z.literal(2),
  /** Array of message parts (text, images, tool calls, etc.) */
  parts: z9.z.array(MessagePartSchema),
  /** Legacy content field for backwards compatibility */
  content: z9.z.string().optional(),
  /** Additional metadata */
  metadata: z9.z.record(z9.z.string(), z9.z.unknown()).optional(),
  /** Provider-specific metadata */
  providerMetadata: z9.z.record(z9.z.string(), z9.z.unknown()).optional()
});
var ProcessorMessageContentSchema = z9.z.object({
  /** Format version - 2 corresponds to AI SDK v4 UIMessage format */
  format: z9.z.literal(2),
  /** Array of message parts (text, images, tool calls, etc.) */
  parts: z9.z.array(MessagePartSchema),
...
var ProcessorMessageSchema = z9.z.object({
  /** Unique message identifier */
  id: z9.z.string(),
  /** Message role */
  role: z9.z.enum(["user", "assistant", "system", "tool"]),
  /** When the message was created */
  createdAt: z9.z.coerce.date(),
  /** Thread identifier for conversation grouping */
  threadId: z9.z.string().optional(),
  /** Resource identifier */
  resourceId: z9.z.string().optional(),
  /** Message type */
  type: z9.z.string().optional(),
  /** Message content with parts */
  content: ProcessorMessageContentSchema
}).passthrough();
var messageListSchema = z9.z.custom().describe("MessageList instance for managing message sources");
var messagesSchema = z9.z.array(ProcessorMessageSchema);
var SystemMessageTextPartSchema = z9.z.object({
  type: z9.z.literal("text"),
  text: z9.z.string()
}).passthrough();
z9.z.object({
  role: z9.z.literal("system"),
  content: z9.z.union([z9.z.string(), z9.z.array(SystemMessageTextPartSchema)]),
  /** Optional experimental provider-specific extensions */
  experimental_providerMetadata: z9.z.record(z9.z.string(), z9.z.unknown()).optional()
}).passthrough();
var CoreMessageSchema = z9.z.object({
  role: z9.z.enum(["system", "user", "assistant", "tool"]),
  content: z9.z.unknown()
}).passthrough();
var systemMessagesSchema = z9.z.array(CoreMessageSchema);
var toolCallSchema = z9.z.object({
  toolName: z9.z.string(),
  toolCallId: z9.z.string(),
  args: z9.z.unknown()
});
var retryCountSchema = z9.z.number().optional();
var ProcessorInputPhaseSchema = z9.z.object({
  phase: z9.z.literal("input"),
  messages: messagesSchema,
  messageList: messageListSchema,
  systemMessages: systemMessagesSchema.optional(),
  retryCount: retryCountSchema
});
var ProcessorInputStepPhaseSchema = z9.z.object({
  phase: z9.z.literal("inputStep"),
  messages: messagesSchema,
  messageList: messageListSchema,
  stepNumber: z9.z.number().describe("The current step number (0-indexed)"),
  systemMessages: systemMessagesSchema.optional(),
  retryCount: retryCountSchema,
  messageId: z9.z.string().optional().describe("The active assistant response message ID for this step"),
  rotateResponseMessageId: z9.z.custom().optional().describe("Rotate the active assistant response message ID when supported by the caller"),
  // Model and tools configuration (can be modified by processors)
  model: z9.z.custom().optional().describe("Current model for this step"),
  tools: z9.z.custom().optional().describe("Current tools available for this step"),
  toolChoice: z9.z.custom().optional().describe("Current tool choice setting"),
  activeTools: z9.z.array(z9.z.string()).optional().describe("Currently active tools"),
  providerOptions: z9.z.custom().optional().describe("Provider-specific options"),
  modelSettings: z9.z.custom().optional().describe("Model settings (temperature, etc.)"),
  structuredOutput: z9.z.custom().optional().describe("Structured output configuration"),
  steps: z9.z.custom().optional().describe("Results from previous steps")
});
var ProcessorOutputStreamPhaseSchema = z9.z.object({
  phase: z9.z.literal("outputStream"),
  part: z9.z.unknown().nullable().describe("The current chunk being processed. Can be null to skip."),
  streamParts: z9.z.array(z9.z.unknown()).describe("All chunks seen so far"),
  state: z9.z.record(z9.z.string(), z9.z.unknown()).describe("Mutable state object that persists across chunks"),
  messageList: messageListSchema.optional(),
  retryCount: retryCountSchema
});
var outputResultSchema = z9.z.object({
  text: z9.z.string().describe("The accumulated text from all steps"),
  usage: z9.z.record(z9.z.string(), z9.z.unknown()).describe("Token usage (cumulative across all steps)"),
  finishReason: z9.z.string().describe("Why the generation finished"),
  steps: z9.z.array(z9.z.unknown()).describe("All LLM step results")
});
var ProcessorOutputResultPhaseSchema = z9.z.object({
  phase: z9.z.literal("outputResult"),
  messages: messagesSchema,
  messageList: messageListSchema,
  retryCount: retryCountSchema,
  result: outputResultSchema.optional()
});
var ProcessorOutputStepPhaseSchema = z9.z.object({
  phase: z9.z.literal("outputStep"),
  messages: messagesSchema,
  messageList: messageListSchema,
  stepNumber: z9.z.number().describe("The current step number (0-indexed)"),
  finishReason: z9.z.string().optional().describe("The finish reason from the LLM (stop, tool-use, length, etc.)"),
  toolCalls: z9.z.array(toolCallSchema).optional().describe("Tool calls made in this step (if any)"),
  text: z9.z.string().optional().describe("Generated text from this step"),
  systemMessages: systemMessagesSchema.optional(),
  retryCount: retryCountSchema
});
var ProcessorStepInputSchema = z9.z.discriminatedUnion("phase", [
...
var ProcessorStepOutputSchema = z9.z.object({
  // Phase field
  phase: z9.z.enum(["input", "inputStep", "outputStream", "outputResult", "outputStep"]),
  // Message-based fields (used by most phases)
  messages: messagesSchema.optional(),
  messageList: messageListSchema.optional(),
  systemMessages: systemMessagesSchema.optional(),
  // Step-based fields
  stepNumber: z9.z.number().optional(),
  // Stream-based fields
  part: z9.z.unknown().nullable().optional(),
  streamParts: z9.z.array(z9.z.unknown()).optional(),
  state: z9.z.record(z9.z.string(), z9.z.unknown()).optional(),
  // Output result fields
  result: outputResultSchema.optional(),
  // Output step fields
  finishReason: z9.z.string().optional(),
  toolCalls: z9.z.array(toolCallSchema).optional(),
  text: z9.z.string().optional(),
  // Retry count
  retryCount: z9.z.number().optional(),
  // Model and tools configuration (for inputStep phase)
  model: z9.z.custom().optional(),
  tools: z9.z.custom().optional(),
  toolChoice: z9.z.custom().optional(),
  activeTools: z9.z.array(z9.z.string()).optional(),
  providerOptions: z9.z.custom().optional(),
  modelSettings: z9.z.custom().optional(),
  structuredOutput: z9.z.custom().optional(),
  steps: z9.z.custom().optional(),
  messageId: z9.z.string().optional(),
  rotateResponseMessageId: z9.z.custom().optional()
});
...
var createTimeTravelExecutionParams = (params) => {
  ...
  for (const [index, entry] of graph.steps.entries()) {
    ...
    stepIds.forEach((stepId) => {
      ...
      if (result) {
        const formattedResult = chunkYVFFNB2F_cjs.removeUndefinedValues(result);
  ...
  const results = await Promise.all(
    entry.steps.map(async (step, i) => {
      ...
      const stepExecResult = await engine.executeStep({
        ...
        ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: parallelSpan }),
        pubsub,
        abortController,
        requestContext,
        outputWriter,
      ...
      const context = createDeprecationProxy(
        {
          ...
          state: executionContext.state,
          retryCount: -1,
          ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: evalSpan }),
  ...
  const results = await Promise.all(
    stepsToRun.map(async (step) => {
      ...
      const stepExecResult = await engine.executeStep({
        ...
        ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: conditionalSpan }),
        pubsub,
        abortController,
        requestContext,
        outputWriter,
...
async function executeLoop(engine, params) {
  ...
  do {
    const stepExecResult = await engine.executeStep({
      ...
      ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: loopSpan }),
      pubsub,
      abortController,
      requestContext,
      outputWriter,
    ...
    const evalSpan = await engine.createChildSpan({
      ...
      options: {
        ...
        input: chunkYVFFNB2F_cjs.selectFields(result.output, ["stepResult", "output.text", "output.object", "messages"]),
        attributes: {
...
async function persistStepUpdate(engine, params) {
  ...
  await engine.wrapDurableOperation(operationId, async () => {
    ...
    const ctx = requestContext instanceof chunk5WBEMKE2_cjs.RequestContext ? requestContext : new chunk5WBEMKE2_cjs.RequestContext(requestContext);
  ...
  if (fn) {
    ...
    duration = await engine.wrapDurableOperation(`workflow.${workflowId}.sleep.${entry.id}`, async () => {
      return fn({
        ...
        retryCount: -1,
        ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: sleepSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
  ...
  if (fn) {
    ...
    const dateResult = await engine.wrapDurableOperation(`workflow.${workflowId}.sleepUntil.${entry.id}`, async () => {
      return fn({
        ...
        retryCount: -1,
        ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: sleepUntilSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
        // TODO: this function shouldn't have suspend probably?
        suspend: async (_suspendPayload) => {
...
async function executeStep(engine, params) {
  ...
  const stepSpan = await engine.createStepSpan({
    ...
    options: {
      ...
      entityType: chunkJUL4UHWQ_cjs.EntityType.WORKFLOW_STEP,
      entityId: step.id,
      input: inputData,
      tracingPolicy: engine.options?.tracingPolicy,
      requestContext
  ...
  const runStep = async (data) => {
    ...
    return chunkJUL4UHWQ_cjs.executeWithContext({ span: stepSpan, fn: () => step.execute(proxiedData) });
  };
  let execResults;
  ...
  const stepRetryResult = await engine.executeStepWithRetry(
    ...
    async () => {
      ...
      const mastraForStep = engine.mastra ? isNestedWorkflow ? engine.mastra : chunkJUL4UHWQ_cjs.wrapMastra(engine.mastra, { currentSpan: stepSpan }) : void 0;
      const output = await runStep({
        ...
        ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: stepSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
...
var DefaultExecutionEngine = class extends ExecutionEngine {
  ...
  deserializeRequestContext(obj) {
    const ctx = new chunk5WBEMKE2_cjs.RequestContext();
  ...
  async execute(params) {
    ...
    for (let i = startIdx; i < steps.length; i++) {
      ...
      lastOutput = await this.executeEntry({
        ...
        timeTravel,
        restart,
        ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: workflowSpan }),
...
function isToolStep(input) {
  return input instanceof chunkNQXA2BUF_cjs.Tool;
}
function isStepParams(input) {
  return input !== null && typeof input === "object" && "id" in input && "execute" in input && !(input instanceof Agent) && !(input instanceof chunkNQXA2BUF_cjs.Tool);
}
...
function createStepFromParams(params) {
  return {
    ...
    inputSchema: params.inputSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(params.inputSchema) : params.inputSchema,
    stateSchema: params.stateSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(params.stateSchema) : void 0,
    outputSchema: params.outputSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(params.outputSchema) : params.outputSchema,
    resumeSchema: params.resumeSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(params.resumeSchema) : void 0,
    suspendSchema: params.suspendSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(params.suspendSchema) : void 0,
    requestContextSchema: params.requestContextSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(params.requestContextSchema) : void 0,
...
function createStepFromAgent(params, agentOrToolOptions) {
  ...
  const outputSchema = chunkVWJ7H3MJ_cjs.toStandardSchema(
    options?.structuredOutput?.schema ?? z9.z.object({ text: z9.z.string() })
  );
  const { retries, scorers, metadata, ...agentOptions } = options ?? {};
  return {
    id: params.id,
    description: params.getDescription(),
    inputSchema: chunkVWJ7H3MJ_cjs.toStandardSchema(
      z9.z.object({
        prompt: z9.z.string()
      })
    ),
    outputSchema: chunkVWJ7H3MJ_cjs.toStandardSchema(outputSchema),
    retries,
    scorers,
    metadata,
    execute: async ({
...
function createStepFromProcessor(processor) {
  const getProcessorEntityType = (phase) => {
    switch (phase) {
      case "input":
        return chunkJUL4UHWQ_cjs.EntityType.INPUT_PROCESSOR;
      case "inputStep":
        return chunkJUL4UHWQ_cjs.EntityType.INPUT_STEP_PROCESSOR;
      case "outputStream":
      case "outputResult":
        return chunkJUL4UHWQ_cjs.EntityType.OUTPUT_PROCESSOR;
      case "outputStep":
        return chunkJUL4UHWQ_cjs.EntityType.OUTPUT_STEP_PROCESSOR;
      default:
        return chunkJUL4UHWQ_cjs.EntityType.OUTPUT_PROCESSOR;
    }
  };
  ...
  return {
    ...
    inputSchema: chunkVWJ7H3MJ_cjs.toStandardSchema(ProcessorStepInputSchema),
    ...
    execute: async ({ inputData, requestContext, tracingContext, outputWriter }) => {
      ...
      const processorObservabilityContext = chunkJUL4UHWQ_cjs.createObservabilityContext(
      ...
      const passThrough = {
        ...
        messageList: messageList ?? (Array.isArray(messages) ? new chunkO6O5MD7Q_cjs.MessageList().add(messages, "input").addSystem(systemMessages ?? []) : void 0),
        stepNumber,
        systemMessages,
        streamParts,
        state,
      ...
      const executePhaseWithSpan = async (fn) => {
        try {
          const result = await chunkJUL4UHWQ_cjs.executeWithContext({ span: processorSpan, fn });
        ...
        switch (phase) {
          ...
          case "outputStream": {
            ...
            if (processor.processOutputStream && part) {
              ...
              const processorObservabilityContext2 = chunkJUL4UHWQ_cjs.createObservabilityContext(
...
function isProcessor(obj) {
  return obj !== null && typeof obj === "object" && "id" in obj && typeof obj.id === "string" && !(obj instanceof Agent) && !(obj instanceof chunkNQXA2BUF_cjs.Tool) && (typeof obj.processInput === "function" || typeof obj.processInputStep === "function" || typeof obj.processOutputStream === "function" || typeof obj.processOutputResult === "function" || typeof obj.processOutputStep === "function");
}
...
var Workflow = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor({
    ...
    this.inputSchema = inputSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(inputSchema) : inputSchema;
    this.outputSchema = outputSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(outputSchema) : outputSchema;
    this.stateSchema = stateSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(stateSchema) : void 0;
    this.requestContextSchema = requestContextSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(requestContextSchema) : void 0;
  ...
  sleep(duration) {
    ...
    this.steps[id] = createStep({
      id,
      inputSchema: z9.z.object({}),
      outputSchema: z9.z.object({}),
      execute: async () => {
        return {};
      }
    });
  ...
  map(mappingConfig, stepOptions) {
    if (typeof mappingConfig === "function") {
      const mappingStep2 = createStep({
        ...
        inputSchema: z9.z.any(),
        outputSchema: z9.z.any(),
  ...
  async listScorers({
    requestContext = new chunk5WBEMKE2_cjs.RequestContext()
  } = {}) {
...
` + errors.map((e) => {
  ...
  async _start({
    ...
    const observabilityContext = chunkJUL4UHWQ_cjs.resolveObservabilityContext(rest);
    const workflowSpan = chunkJUL4UHWQ_cjs.getOrCreateSpan({
      type: "workflow_run" /* WORKFLOW_RUN */,
      name: `workflow run: '${this.workflowId}'`,
      entityType: chunkJUL4UHWQ_cjs.EntityType.WORKFLOW_RUN,
    ...
    const result = await this.executionEngine.execute({
      ...
      pubsub: this.pubsub,
      retryConfig: this.retryConfig,
      requestContext: requestContext ?? new chunk5WBEMKE2_cjs.RequestContext(),
  ...
  async _resume(params) {
    const observabilityContext = chunkJUL4UHWQ_cjs.resolveObservabilityContext(params);
    const workflowsStore = await this.#mastra?.getStorage()?.getStore("workflows");
    ...
    const requestContextToUse = params.requestContext ?? new chunk5WBEMKE2_cjs.RequestContext();
  ...
  async _restart({
    ...
    const requestContextToUse = requestContext ?? new chunk5WBEMKE2_cjs.RequestContext();
...
var languageModelUsageSchema = z9__default.default.object({
  inputTokens: z9__default.default.number().optional(),
  outputTokens: z9__default.default.number().optional(),
  totalTokens: z9__default.default.number().optional(),
  reasoningTokens: z9__default.default.number().optional(),
  cachedInputTokens: z9__default.default.number().optional()
});
var llmIterationStepResultSchema = z9__default.default.object({
  reason: z9__default.default.string(),
  warnings: z9__default.default.array(z9__default.default.any()),
  isContinued: z9__default.default.boolean(),
  logprobs: z9__default.default.any().optional(),
  totalUsage: languageModelUsageSchema.optional(),
  headers: z9__default.default.record(z9__default.default.string(), z9__default.default.string()).optional(),
  messageId: z9__default.default.string().optional(),
  request: z9__default.default.record(z9__default.default.string(), z9__default.default.any()).optional()
});
var llmIterationOutputSchema = z9__default.default.object({
  messageId: z9__default.default.string(),
  messages: z9__default.default.object({
    all: z9__default.default.array(z9__default.default.any()),
    // ModelMessage[] but too complex to validate at runtime
    user: z9__default.default.array(z9__default.default.any()),
    nonUser: z9__default.default.array(z9__default.default.any())
  }),
  output: z9__default.default.object({
    text: z9__default.default.string().optional(),
    reasoning: z9__default.default.array(z9__default.default.any()).optional(),
    reasoningText: z9__default.default.string().optional(),
    files: z9__default.default.array(z9__default.default.any()).optional(),
    // GeneratedFile[]
    toolCalls: z9__default.default.array(z9__default.default.any()).optional(),
    // TypedToolCall[]
    toolResults: z9__default.default.array(z9__default.default.any()).optional(),
    // TypedToolResult[]
    sources: z9__default.default.array(z9__default.default.any()).optional(),
    // LanguageModelV2Source[]
    staticToolCalls: z9__default.default.array(z9__default.default.any()).optional(),
    dynamicToolCalls: z9__default.default.array(z9__default.default.any()).optional(),
    staticToolResults: z9__default.default.array(z9__default.default.any()).optional(),
    dynamicToolResults: z9__default.default.array(z9__default.default.any()).optional(),
    usage: languageModelUsageSchema,
    steps: z9__default.default.array(z9__default.default.any())
    // StepResult[]
  }),
  metadata: z9__default.default.object({
    id: z9__default.default.string().optional(),
    model: z9__default.default.string().optional(),
    modelId: z9__default.default.string().optional(),
    modelMetadata: z9__default.default.object({
      modelId: z9__default.default.string(),
      modelVersion: z9__default.default.string(),
      modelProvider: z9__default.default.string()
    }).optional(),
    timestamp: z9__default.default.date().optional(),
    providerMetadata: z9__default.default.record(z9__default.default.string(), z9__default.default.any()).optional(),
    headers: z9__default.default.record(z9__default.default.string(), z9__default.default.string()).optional(),
    request: z9__default.default.record(z9__default.default.string(), z9__default.default.any()).optional()
  }),
  stepResult: llmIterationStepResultSchema,
  processorRetryCount: z9__default.default.number().optional(),
  processorRetryFeedback: z9__default.default.string().optional(),
  isTaskCompleteCheckFailed: z9__default.default.boolean().optional()
  //true if the isTaskComplete check failed and LLM has to run again
});
var toolCallInputSchema = z9__default.default.object({
  toolCallId: z9__default.default.string(),
  toolName: z9__default.default.string(),
  args: z9__default.default.record(z9__default.default.string(), z9__default.default.any()),
  providerMetadata: z9__default.default.record(z9__default.default.string(), z9__default.default.any()).optional(),
  providerExecuted: z9__default.default.boolean().optional(),
  output: z9__default.default.any().optional()
});
var toolCallOutputSchema = toolCallInputSchema.extend({
  result: z9__default.default.any().optional(),
  error: z9__default.default.any().optional()
});
var MastraScorer = class _MastraScorer {
  ...
  async run(input) {
    ...
    const observabilityContext = chunkJUL4UHWQ_cjs.resolveObservabilityContext(input);
  ...
  toMastraWorkflow() {
    ...
    const workflow = createWorkflow({
      ...
      outputSchema: z9.z.object({
        run: z9.z.any(),
        score: z9.z.number(),
        reason: z9.z.string().optional(),
        preprocessResult: z9.z.any().optional(),
        analyzeResult: z9.z.any().optional(),
        preprocessPrompt: z9.z.string().optional(),
        analyzePrompt: z9.z.string().optional(),
        generateScorePrompt: z9.z.string().optional(),
        generateReasonPrompt: z9.z.string().optional()
      }),
      options: {
  ...
  async executePromptStep(scorerStep, observabilityContext, context) {
    ...
    const resolvedModel = await chunkP2PWEGRW_cjs.resolveModelConfig(modelConfig, void 0, this.#mastra);
    ...
    if (scorerStep.name === "generateScore") {
      ...
      if (isSupportedLanguageModel(resolvedModel)) {
        result = await tryGenerateWithJsonFallback(judge, prompt, {
          structuredOutput: {
            schema: z9.z.object({ score: z9.z.number() })
          },
          ...observabilityContext
        });
      } else {
        const schema = z9.z.object({
          score: z9.z.number()
        });
        const standardSchema = chunkVWJ7H3MJ_cjs.toStandardSchema(schema);
        result = await judge.generateLegacy(prompt, {
          output: chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(standardSchema),
          ...observabilityContext
        });
      }
      ...
      const standardSchema = chunkVWJ7H3MJ_cjs.toStandardSchema(promptStep.outputSchema);
      let result;
      if (isSupportedLanguageModel(resolvedModel)) {
        result = await tryGenerateWithJsonFallback(judge, prompt, {
          structuredOutput: {
...
var defaultCompletionSchema = z9.z.object({
  isComplete: z9.z.boolean().describe("Whether the task is complete"),
  completionReason: z9.z.string().describe("Explanation of why the task is or is not complete"),
  finalResult: z9.z.string().optional().describe("The final result text to return to the user. omit if primitive result is sufficient")
});
...
var finalResultSchema = z9.z.object({
  finalResult: z9.z.string().optional().describe("The final result text to return to the user, omit if primitive result is sufficient")
});
...
var AISDKV5InputStream = class extends MastraModelInput {
  ...
  constructor({
    ...
    this.#generateId = generateId2 ?? chunkCFMZZDO2_cjs.generateId;
  }
  async transform({
    runId,
    stream,
...
You don't need to format your response as JSON unless the user asks you to. Just ensure your natural language response includes relevant information for each field in the schema above.`
  ...
  if (isOpenAIStrictMode && responseFormat?.schema) {
    responseFormat.schema = schemaCompat.prepareJsonSchemaForOpenAIStrictMode(responseFormat.schema);
  }
      ...
      try {
        ...
        return await pRetry.default(
          ...
          },
          {
            ...
            signal: abortSignal,
            shouldRetry(context) {
              if (chunkCFMZZDO2_cjs.APICallError.isInstance(context.error)) {
...
function findProviderToolByName(tools, toolName) {
  ...
  return Object.values(tools).find((t) => chunkNQXA2BUF_cjs.isProviderTool(t) && chunkNQXA2BUF_cjs.getProviderToolName(t.id) === toolName);
}
function inferProviderExecuted(providerExecuted, tool2) {
  if (providerExecuted !== void 0) return providerExecuted;
  return chunkNQXA2BUF_cjs.isProviderTool(tool2) ? true : void 0;
}
        ...
        if (inputStepProcessors && inputStepProcessors.length > 0) {
          ...
          try {
            ...
            const processInputStepResult = await processorRunner.runProcessInputStep({
              ...
              ...chunkJUL4UHWQ_cjs.createObservabilityContext(stepTracingContext),
              requestContext,
              model,
              steps: inputData.output?.steps || [],
              messageId: currentStep.messageId,
              rotateResponseMessageId: () => {
                currentMessageId = _internal?.generateId?.() ?? chunkCFMZZDO2_cjs.generateId();
            ...
            if (processInputStepResult.tools && currentStep.tools) {
              ...
              for (const [name, tool2] of Object.entries(currentStep.tools)) {
                if (chunkNQXA2BUF_cjs.isMastraTool(tool2)) {
                  convertedTools[name] = chunkYVFFNB2F_cjs.makeCoreTool(
                    tool2,
                    {
                      name,
                      runId,
...
Analyse the suspended tools: ${JSON.stringify(suspendedTools)}, using the messages available to you and the resumeSchema of each suspended tool, find the tool whose resumeData you can construct properly.
        ...
        if (isSupportedLanguageModel(currentStep.model)) {
          modelResult = chunkJUL4UHWQ_cjs.executeWithContextSync({
        ...
        if (currentStep.model instanceof chunkP2PWEGRW_cjs.ModelRouterLanguageModel) {
        ...
        try {
          ...
          const isUpstreamError = chunkCFMZZDO2_cjs.APICallError.isInstance(error);
          if (isUpstreamError) {
      ...
      if (outputProcessors && outputProcessors.length > 0) {
        ...
        try {
          ...
          await processorRunner.runProcessOutputStep({
            ...
            text: immediateText,
            ...chunkJUL4UHWQ_cjs.createObservabilityContext(outputStepTracingContext),
            requestContext,
...
function createLLMMappingStep({ models, _internal, ...rest }, llmExecutionStep) {
  ...
  const observabilityContext = chunkJUL4UHWQ_cjs.createObservabilityContext(rest.modelSpanTracker?.getTracingContext());
  ...
  return createStep({
    ...
    inputSchema: z9__default.default.array(toolCallOutputSchema),
    outputSchema: llmIterationOutputSchema,
          ...
          for (const toolCall of errorResults) {
            ...
            rest.messageList.updateToolInvocation({
              ...
              toolInvocation: {
                state: "result",
                toolCallId: toolCall.toolCallId,
                toolName: chunkO6O5MD7Q_cjs.sanitizeToolName(toolCall.toolName),
                args: toolCall.args,
  ...
  return createStep({
    ...
    execute: async ({ inputData, suspend, resumeData: workflowResumeData, requestContext }) => {
      ...
      try {
        ...
        const approvalSchema = chunkVWJ7H3MJ_cjs.toStandardSchema(
          z9__default.default.object({
            approved: z9__default.default.boolean().describe(
          ...
          if (!resumeData) {
            controller.enqueue({
              ...
              payload: {
                ...
                args: inputData.args,
                resumeSchema: JSON.stringify(chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(approvalSchema))
              }
            });
            addToolMetadata({
              toolCallId: inputData.toolCallId,
              ...
              controller.enqueue({
                ...
                payload: {
                  ...
                  resumeSchema: JSON.stringify(
                    chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(
                      chunkVWJ7H3MJ_cjs.toStandardSchema(
                        z9__default.default.object({
                          approved: z9__default.default.boolean().describe(
                            "Controls if the tool call is approved or not, should be true when approved and false when declined"
                          )
...
function workflowLoopStream({
  ...
  return new web.ReadableStream({
    start: async (controller) => {
      const requestContext = rest.requestContext ?? new chunk5WBEMKE2_cjs.RequestContext();
      ...
      const dataChunkProcessorRunner = hasOutputProcessors ? new ProcessorRunner({
        outputProcessors: rest.outputProcessors,
        logger: rest.logger || new chunk7XAECHYL_cjs.ConsoleLogger({ level: "error" }),
        agentName: agentId || "unknown"
      }) : void 0;
      ...
      const executionResult = resumeContext ? await run.resume({
        ...
        ...chunkJUL4UHWQ_cjs.createObservabilityContext(rest.modelSpanTracker?.getTracingContext()),
        requestContext,
        label: toolCallId
      }) : await run.start({
...
function loop({
  ...
  const internalToUse = {
    ...
    generateId: _internal?.generateId || (() => chunkCFMZZDO2_cjs.generateId()),
...
var MastraLLMVNext = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  stream({
    resumeContext,
    runId,
    stopWhen = chunkY3APFUXZ_cjs.stepCountIs(5),
    maxSteps,
    tools = {},
    modelSettings,
    toolChoice = "auto",
    ...
    if (maxSteps && typeof maxSteps === "number") {
      stopWhenToUse = chunkY3APFUXZ_cjs.stepCountIs(maxSteps);
    } else {
        ...
        options: {
          ...
          onStepFinish: async (props) => {
            ...
            if (!isNaN(remainingTokens) && remainingTokens > 0 && remainingTokens < 2e3) {
              ...
              await chunkYVFFNB2F_cjs.delay(10 * 1e3);
            }
          },
...
var PRIMITIVE_TYPES = z9__default.default.enum(["agent", "workflow", "none", "tool"]);

// src/loop/network/index.ts
function schemaToJsonSchema(schema) {
  if (chunkVWJ7H3MJ_cjs.isStandardSchemaWithJSON(schema)) {
    return chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(schema);
  }
  try {
    const standardSchema = chunkVWJ7H3MJ_cjs.toStandardSchema(schema);
    return chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(standardSchema);
  } catch {
...
async function safeParseLLMJson(text) {
  ...
  const { value, state } = await chunkY3APFUXZ_cjs.parsePartialJson(preprocessed);
...
async function getRoutingAgent({
  ...
  const workflowList = Object.entries(workflowsToUse).map(([name, workflow]) => {
    return ` - **${name}**: ${workflow.description}, input schema: ${JSON.stringify(
      schemaToJsonSchema(workflow.inputSchema ?? z9__default.default.object({}))
    )}`;
  }).join("\n");
  ...
  const toolList = Object.entries({ ...toolsToUse, ...memoryTools, ...clientToolsToUse || {} }).map(([name, tool2]) => {
    const inputSchema = "inputSchema" in tool2 ? tool2.inputSchema ?? z9__default.default.object({}) : z9__default.default.object({});
...
async function prepareMemoryStep({
  ...
  if (typeof messages === "string") {
    ...
    const messageList = new chunkO6O5MD7Q_cjs.MessageList({
      threadId: thread?.id,
      resourceId: thread?.resourceId
    });
...
async function saveMessagesWithProcessors(memory, messages, processorRunner, context) {
  ...
  await processorRunner.runOutputProcessors(
    messageList,
    chunkJUL4UHWQ_cjs.resolveObservabilityContext(observabilityContext),
    requestContext
  );
...
async function createNetworkLoop({
  ...
  const routingStep = createStep({
    ...
    inputSchema: z9__default.default.object({
      task: z9__default.default.string(),
      primitiveId: z9__default.default.string(),
      primitiveType: PRIMITIVE_TYPES,
      result: z9__default.default.string().optional(),
      iteration: z9__default.default.number(),
      threadId: z9__default.default.string().optional(),
      threadResourceId: z9__default.default.string().optional(),
      isOneOff: z9__default.default.boolean(),
      verboseIntrospection: z9__default.default.boolean()
    }),
    outputSchema: z9__default.default.object({
      task: z9__default.default.string(),
      primitiveId: z9__default.default.string(),
      primitiveType: PRIMITIVE_TYPES,
      prompt: z9__default.default.string(),
      result: z9__default.default.string(),
      isComplete: z9__default.default.boolean().optional(),
      selectionReason: z9__default.default.string(),
      iteration: z9__default.default.number(),
      conversationContext: z9__default.default.array(z9__default.default.any()).optional()
    }),
    execute: async ({ inputData, getInitData, writer }) => {
      ...
      const options = {
        structuredOutput: {
          schema: z9__default.default.object({
            primitiveId: z9__default.default.string().describe("The id of the primitive to be called"),
            primitiveType: PRIMITIVE_TYPES.describe("The type of the primitive to be called"),
            prompt: z9__default.default.string().describe("The json string or text value to be sent to the primitive"),
            selectionReason: z9__default.default.string().describe("The reason you picked the primitive")
          })
        },
        requestContext,
        maxSteps: 1,
  ...
  const toolStep = createStep({
    ...
    resumeSchema: z9__default.default.object({
      approved: z9__default.default.boolean().describe("Controls if the tool call is approved or not, should be true when approved and false when declined")
    }),
    execute: async ({ inputData, getInitData, writer, resumeData, mastra, suspend }) => {
      ...
      if (toolRequiresApproval) {
        ...
        if (!resumeData) {
          const approvalSchema = z9__default.default.object({
            approved: z9__default.default.boolean().describe(
              "Controls if the tool call is approved or not, should be true when approved and false when declined"
            )
          });
          const requireApprovalResumeSchema = JSON.stringify(
            chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(chunkVWJ7H3MJ_cjs.toStandardSchema(approvalSchema))
          );
          await saveMessagesWithProcessors(
            memory,
            [
      ...
      const finalResult = await tool2.execute(
        inputDataToUse,
        {
          ...
          ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: void 0 }),
          writer
        },
        { toolCallId, messages: [] }
      );
  ...
  const finishStep = createStep({
    ...
    outputSchema: z9__default.default.object({
      task: z9__default.default.string(),
      result: z9__default.default.string(),
      isComplete: z9__default.default.boolean(),
      iteration: z9__default.default.number()
    }),
  ...
  const networkWorkflow = createWorkflow({
    ...
    outputSchema: z9__default.default.object({
      ...
      result: z9__default.default.string(),
      isComplete: z9__default.default.boolean().optional(),
      completionReason: z9__default.default.string().optional(),
      iteration: z9__default.default.number(),
      threadId: z9__default.default.string().optional(),
      threadResourceId: z9__default.default.string().optional(),
      isOneOff: z9__default.default.boolean()
...
async function networkLoop({
        ...
        if (requireApprovalMetadata || suspendedTools) {
          ...
          `;
              ...
              const result = llm.stream({
                ...
                messageList,
                agentId: routingAgent.id,
                ...chunkJUL4UHWQ_cjs.resolveObservabilityContext(routingAgentOptions ?? {}),
                structuredOutput: {
                  schema: z9__default.default.object({
                    resumeData: z9__default.default.string()
                  })
                }
              });
              const object = await result.object;
  ...
  const validationStep = createStep({
    ...
    outputSchema: z9__default.default.object({
      ...
      prompt: z9__default.default.string(),
      result: z9__default.default.string(),
      structuredObject: z9__default.default.any().optional(),
      isComplete: z9__default.default.boolean().optional(),
      completionReason: z9__default.default.string().optional(),
      iteration: z9__default.default.number(),
      validationPassed: z9__default.default.boolean().optional(),
      validationFeedback: z9__default.default.string().optional()
    }),
    execute: async ({ inputData, writer }) => {
  ...
  const finalStep = createStep({
    ...
    outputSchema: z9__default.default.object({
      ...
      prompt: z9__default.default.string(),
      result: z9__default.default.string(),
      object: z9__default.default.any().optional(),
      isComplete: z9__default.default.boolean().optional(),
      completionReason: z9__default.default.string().optional(),
      iteration: z9__default.default.number(),
      validationPassed: z9__default.default.boolean().optional()
...
var import_fast_deep_equal = chunkBVWXTWXP_cjs.__toESM(require_fast_deep_equal(), 1);
var AgentLegacyHandler = class {
  ...
  __primitive({
    ...
    return {
      before: async () => {
        ...
        const agentSpan = chunkJUL4UHWQ_cjs.getOrCreateSpan({
          type: "agent_run" /* AGENT_RUN */,
          name: `agent run: '${this.capabilities.id}'`,
          entityType: chunkJUL4UHWQ_cjs.EntityType.AGENT,
        ...
        const innerObservabilityContext = chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: agentSpan });
        ...
        let messageList = new chunkO6O5MD7Q_cjs.MessageList({
          threadId,
          resourceId,
      ...
      after: async ({
        ...
        const messageListResponses = new chunkO6O5MD7Q_cjs.MessageList({
          threadId,
          resourceId,
          generateMessageId: this.capabilities.mastra?.generateId?.bind(this.capabilities.mastra),
          // @ts-expect-error Flag for agent network messages
        ...
        if (memory && resourceId && thread2) {
          try {
            ...
            if (shouldGenerate && !thread2.title && userMessage) {
              const observabilityContext2 = chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: agentSpan });
              promises.push(
        ...
        await this.capabilities.runScorers({
          ...
          threadId,
          resourceId,
          ...chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: agentSpan })
        });
        const scoringData = {
          input: {
  ...
  async prepareLLMOptions(messages, options, methodType) {
    ...
    const resourceIdFromContext = requestContext.get(chunk5WBEMKE2_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContext.get(chunk5WBEMKE2_cjs.MASTRA_THREAD_ID_KEY);
    ...
    const { before, after } = this.__primitive({
      ...
      methodType,
      tracingOptions,
      ...chunkJUL4UHWQ_cjs.resolveObservabilityContext(args)
    });
    let messageList;
    let thread;
    let threadExists;
  ...
  async generateLegacy(messages, generateOptions = {}) {
    ...
    const observabilityContext = chunkJUL4UHWQ_cjs.createObservabilityContext({ currentSpan: agentSpan });
    ...
    if (!output || experimental_output) {
      ...
      const outputProcessorResult2 = await this.capabilities.__runOutputProcessors({
        requestContext: contextWithMemory || new chunk5WBEMKE2_cjs.RequestContext(),
        ...observabilityContext,
      ...
      options: {
        ...
        onFinish: async (payload) => {
          if (payload.finishReason === "error") {
            ...
            const isUpstreamError = chunkCFMZZDO2_cjs.APICallError.isInstance(payload.error);
            if (isUpstreamError) {
              const providerInfo = provider ? ` from ${provider}` : "";
...
var import_fast_deep_equal2 = chunkBVWXTWXP_cjs.__toESM(require_fast_deep_equal(), 1);
var storageThreadSchema = z9.z.object({
  id: z9.z.string(),
  title: z9.z.string().optional(),
  resourceId: z9.z.string(),
  createdAt: z9.z.date(),
  updatedAt: z9.z.date(),
  metadata: z9.z.record(z9.z.string(), z9.z.any()).optional()
});
var prepareToolsStepOutputSchema = z9.z.object({
  convertedTools: z9.z.record(z9.z.string(), z9.z.any())
});
var prepareMemoryStepOutputSchema = z9.z.object({
  threadExists: z9.z.boolean(),
  thread: storageThreadSchema.optional(),
  messageList: z9.z.instanceof(chunkO6O5MD7Q_cjs.MessageList),
  /** Shared processor states map that persists across loop iterations for both input and output processors */
  processorStates: z9.z.instanceof(Map),
  /** Tripwire data when input processor triggered abort */
  tripwire: z9.z.object({
    reason: z9.z.string(),
    retry: z9.z.boolean().optional(),
    metadata: z9.z.unknown().optional(),
    processorId: z9.z.string().optional()
  }).optional()
});
...
function createStreamStep({
  ...
  return createStep({
    ...
    outputSchema: z9.z.instanceof(MastraModelOutput),
    execute: async ({ inputData, ...observabilityContext }) => {
      ...
      const processors = validatedInputData.outputProcessors || (capabilities.outputProcessors ? typeof capabilities.outputProcessors === "function" ? await capabilities.outputProcessors({
        requestContext: validatedInputData.requestContext || new chunk5WBEMKE2_cjs.RequestContext()
...
var Agent = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  constructor(config) {
    ...
    if (config.voice) {
      ...
      this.#voice = new chunkZC4FJVJZ_cjs.DefaultVoice();
    }
    if (config.workspace) {
    ...
    if (config.requestContextSchema) {
      this.#requestContextSchema = chunkVWJ7H3MJ_cjs.toStandardSchema(config.requestContextSchema);
    }
  ...
  async getSkillsProcessors(configuredProcessors, requestContext) {
    const workspace = await this.getWorkspace({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() });
    if (!workspace?.skills) {
      return [];
    }
...
${errorMessages}`,
   ...
   * ```
   */
  listAgents({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
  ...
  async listResolvedOutputProcessors(requestContext, configuredProcessorOverrides) {
    const configuredProcessors = configuredProcessorOverrides ? configuredProcessorOverrides : this.#outputProcessors ? typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() }) : this.#outputProcessors : [];
    const memory = await this.getMemory({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() });
  ...
  async listResolvedInputProcessors(requestContext, configuredProcessorOverrides) {
    const configuredProcessors = configuredProcessorOverrides ? configuredProcessorOverrides : this.#inputProcessors ? typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() }) : this.#inputProcessors : [];
    const memory = await this.getMemory({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() });
  ...
  async resolveProcessorById(processorId, requestContext) {
    const ctx = requestContext || new chunk5WBEMKE2_cjs.RequestContext();
  ...
  async listConfiguredInputProcessors(requestContext) {
    ...
    const configuredProcessors = typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() }) : this.#inputProcessors;
  ...
  async listConfiguredOutputProcessors(requestContext) {
    ...
    const configuredProcessors = typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: requestContext || new chunk5WBEMKE2_cjs.RequestContext() }) : this.#outputProcessors;
    return configuredProcessors;
  }
  /**
  ...
  async getConfiguredProcessorWorkflows() {
    const workflows = [];
    if (this.#inputProcessors) {
      const inputProcessors = typeof this.#inputProcessors === "function" ? await this.#inputProcessors({ requestContext: new chunk5WBEMKE2_cjs.RequestContext() }) : this.#inputProcessors;
    ...
    if (this.#outputProcessors) {
      const outputProcessors = typeof this.#outputProcessors === "function" ? await this.#outputProcessors({ requestContext: new chunk5WBEMKE2_cjs.RequestContext() }) : this.#outputProcessors;
   ...
   * ```
   */
  async getMemory({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
    if (!this.#memory) {
      return void 0;
    }
    let resolvedMemory;
  ...
  async getVoice({ requestContext } = {}) {
    if (this.#voice) {
      ...
      return new chunkZC4FJVJZ_cjs.DefaultVoice();
    }
  }
  /**
   ...
   * ```
   */
  getInstructions({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
    if (typeof this.#instructions === "function") {
   ...
   * ```
   */
  getDefaultOptions({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
   ...
   * ```
   */
  getDefaultNetworkOptions({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
  ...
  listTools({ requestContext = new chunk5WBEMKE2_cjs.RequestContext() } = {}) {
    if (typeof this.#tools !== "function") {
      return chunkYVFFNB2F_cjs.ensureToolProperties(this.#tools);
    }
    ...
    return resolveMaybePromise(result, (tools) => {
      ...
      return chunkYVFFNB2F_cjs.ensureToolProperties(tools);
    });
  }
  /**
    ...
    return modelSelectionPromise.then((modelSelection) => {
      ...
      return resolveMaybePromise(resolvedModel, (modelInfo) => {
        ...
        if (isSupportedLanguageModel(modelInfo)) {
          ...
          llm = new chunkFYQXIWRH_cjs.MastraLLMV1({
            model: modelInfo,
            mastra: this.#mastra,
            options: { tracingPolicy: this.#options?.tracingPolicy }
          });
  ...
  async resolveModelConfig(modelConfig, requestContext) {
    try {
      return await chunkP2PWEGRW_cjs.resolveModelConfig(modelConfig, requestContext, this.#mastra);
    } catch (error) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError({
   ...
   * ```
   */
  async getModelList(requestContext = new chunk5WBEMKE2_cjs.RequestContext()) {
  ...
  async generateTitleFromUserMessage({
    ...
    const normMessage = new chunkO6O5MD7Q_cjs.MessageList().add(message, "user").get.all.aiV5.ui().at(-1);
    if (!normMessage) {
    ...
    if (isSupportedLanguageModel(llm.getModel())) {
      const messageList = new chunkO6O5MD7Q_cjs.MessageList().add(
        [
          {
            role: "system",
  ...
  async genTitle(userMessage, requestContext, observabilityContext, model, instructions) {
    try {
      if (userMessage) {
        const normMessage = new chunkO6O5MD7Q_cjs.MessageList().add(userMessage, "user").get.all.ui().at(-1);
        if (normMessage) {
  ...
  async listMemoryTools({
    ...
    if (memoryTools) {
      ...
      for (const [toolName, tool2] of Object.entries(memoryTools)) {
        ...
        const convertedToCoreTool = chunkYVFFNB2F_cjs.makeCoreTool(toolObj, options, void 0, autoResumeSuspendedTools);
  ...
  async listWorkspaceTools({
    ...
    const workspaceTools = chunkCTFO2ENI_cjs.createWorkspaceTools(workspace);
  ...
  async listSkillTools({
    ...
    const skillTools = chunkCTFO2ENI_cjs.createSkillTools(workspace.skills);
  ...
  async listAssignedTools({
    ...
    const assignedCoreToolEntries = await Promise.all(
      assignedToolEntries.map(async ([k, tool2]) => {
        ...
        return [k, chunkYVFFNB2F_cjs.makeCoreTool(tool2, options, void 0, autoResumeSuspendedTools)];
      })
    );
    ...
    if (toolsFromToolsets.length > 0) {
      ...
      for (const toolset of toolsFromToolsets) {
        for (const [toolName, tool2] of Object.entries(toolset)) {
          ...
          const convertedToCoreTool = chunkYVFFNB2F_cjs.makeCoreTool(toolObj, options, "toolset", autoResumeSuspendedTools);
  ...
  async listClientTools({
    ...
    if (clientToolsForInput.length > 0) {
      ...
      for (const [toolName, tool2] of clientToolsForInput) {
        ...
        const convertedToCoreTool = chunkYVFFNB2F_cjs.makeCoreTool(toolRest, options, "client-tool", autoResumeSuspendedTools);
        toolsForRequest[toolName] = convertedToCoreTool;
      }
    }
    return toolsForRequest;
  ...
  async listAgentTools({
    ...
    if (Object.keys(agents).length > 0) {
      for (const [agentName, agent] of Object.entries(agents)) {
        const agentInputSchema = z9.z.object({
          prompt: z9.z.string().describe("The prompt to send to the agent"),
          // Using .nullish() instead of .optional() because OpenAI sends null for unfilled optional fields
          threadId: z9.z.string().nullish().describe("Thread ID for conversation continuity for memory messages"),
          resourceId: z9.z.string().nullish().describe("Resource/user identifier for memory messages"),
          instructions: z9.z.string().nullish().describe(
          ...
          maxSteps: z9.z.number().min(3).nullish().describe("Maximum number of execution steps for the sub-agent")
        ...
        const agentOutputSchema = z9.z.object({
          text: z9.z.string().describe("The response from the agent"),
          subAgentThreadId: z9.z.string().describe("The thread ID of the agent").optional(),
          subAgentResourceId: z9.z.string().describe("The resource ID of the agent").optional(),
          subAgentToolResults: z9.z.array(
            z9.z.object({
              toolName: z9.z.string().describe("The name of the tool"),
              toolCallId: z9.z.string().describe("The ID of the tool call"),
              result: z9.z.any().describe("The result of the tool call"),
              args: z9.z.any().describe("The arguments of the tool call").optional(),
              isError: z9.z.boolean().describe("Whether the tool call resulted in an error").optional()
            })
        ...
        const toolObj = chunkNQXA2BUF_cjs.createTool({
          id: `agent-${agentName}`,
...
${effectiveInstructions}`;
            ...
            try {
              ...
              if ((methodType === "generate" || methodType === "generateLegacy") && supportedLanguageModelSpecifications.includes(modelVersion)) {
                const generateResult = resumeData ? await agent.resumeGenerate(resumeData, {
                  ...
                  requestContext,
                  ...chunkJUL4UHWQ_cjs.resolveObservabilityContext(context ?? {}),
        ...
        convertedAgentTools[`agent-${agentName}`] = chunkYVFFNB2F_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async listWorkflowTools({
    ...
    if (Object.keys(workflows).length > 0) {
      for (const [workflowName, workflow] of Object.entries(workflows)) {
        const inputDataJsonSchema = workflow.inputSchema ? chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(workflow.inputSchema, { io: "input" }) : { type: "object", additionalProperties: true };
        const inputProperties = {
          inputData: inputDataJsonSchema
        };
        const inputRequired = ["inputData"];
        if (workflow.stateSchema) {
          inputProperties.initialState = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(workflow.stateSchema, { io: "input" });
        }
        ...
        if (workflow.outputSchema) {
          outputResultProperties.result = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(workflow.outputSchema, { io: "output" });
        }
        const outputSchema = {
          anyOf: [
            {
          ...
          execute: async (inputData, context) => {
            ...
            try {
              ...
              if (result?.status === "success") {
                ...
                const normalizedResumeSchema = resumeSchema ? chunkVWJ7H3MJ_cjs.toStandardSchema(resumeSchema) : void 0;
                return suspend?.(suspendPayload, {
                  resumeLabel: suspendedStepIds,
                  resumeSchema: normalizedResumeSchema ? JSON.stringify(chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(normalizedResumeSchema)) : void 0,
                  runId: runIdToUse
                });
              } else {
                return {
        ...
        convertedWorkflowTools[`workflow-${workflowName}`] = chunkYVFFNB2F_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async convertTools({
    ...
    if (this.#mastra) {
      mastraProxy = chunkYVFFNB2F_cjs.createMastraProxy({ mastra: this.#mastra, logger });
    }
  ...
  async prepareModels(requestContext, resolvedSelection) {
    ...
    if (!Array.isArray(selection)) {
      ...
      let headers;
      if (resolvedModel instanceof chunkP2PWEGRW_cjs.ModelRouterLanguageModel) {
    ...
    const models = await Promise.all(
      selection.map(async (modelConfig) => {
        ...
        let headers;
        if (model instanceof chunkP2PWEGRW_cjs.ModelRouterLanguageModel) {
  ...
  async #execute({ methodType, resumeContext, ...options }) {
    ...
    const requestContext = options.requestContext || new chunk5WBEMKE2_cjs.RequestContext();
    const resourceIdFromContext = requestContext.get(chunk5WBEMKE2_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContext.get(chunk5WBEMKE2_cjs.MASTRA_THREAD_ID_KEY);
    const threadFromArgs = resolveThreadIdFromArgs({
      memory: {
    ...
    if ("structuredOutput" in options && options.structuredOutput?.schema && !options.structuredOutput?.model) {
      ...
      if (targetProvider.includes("openai") || targetModelId?.includes("openai")) {
        options = {
          ...
          structuredOutput: {
            ...options.structuredOutput,
            schema: schemaCompat.wrapSchemaWithNullTransform(options.structuredOutput.schema)
          }
        };
      }
    }
  ...
  async network(messages, options) {
    const requestContextToUse = options?.requestContext || new chunk5WBEMKE2_cjs.RequestContext();
    ...
    const resourceIdFromContext = requestContextToUse.get(chunk5WBEMKE2_cjs.MASTRA_RESOURCE_ID_KEY);
    const threadIdFromContext = requestContextToUse.get(chunk5WBEMKE2_cjs.MASTRA_THREAD_ID_KEY);
  ...
  async generate(messages, options) {
    ...
    const mergedOptions = chunkYVFFNB2F_cjs.deepMerge(
      defaultOptions,
      options ?? {}
    );
    ...
    const executeOptions = {
      ...
      structuredOutput: mergedOptions.structuredOutput ? {
        ...
        schema: chunkVWJ7H3MJ_cjs.toStandardSchema(mergedOptions.structuredOutput.schema)
      } : void 0,
      messages,
      methodType: "generate",
  ...
  async resumeStream(resumeData, streamOptions) {
    ...
    let mergedStreamOptions = chunkYVFFNB2F_cjs.deepMerge(
      defaultOptions,
      streamOptions ?? {}
    );
    const llm = await this.getLLM({
    ...
    const result = await this.#execute({
      ...
      structuredOutput: mergedStreamOptions.structuredOutput ? {
        ...
        schema: chunkVWJ7H3MJ_cjs.toStandardSchema(mergedStreamOptions.structuredOutput.schema)
      } : void 0,
      messages: [],
      resumeContext: {
        resumeData,
...
var ModerationProcessor = class _ModerationProcessor {
  ...
  async moderateContent(content, isStream = false, observabilityContext) {
    ...
    try {
      ...
      const schema = z9__default.default.object({
        category_scores: z9__default.default.array(
          z9__default.default.object({
            category: z9__default.default.enum(this.categories).describe("The moderation category being evaluated"),
            score: z9__default.default.number().min(0).max(1).describe("Confidence score between 0 and 1 indicating how strongly the content matches this category")
          })
        ).describe("Array of flagged categories with their confidence scores").nullable(),
        reason: z9__default.default.string().describe("Brief explanation of why content was flagged").nullable()
      });
      let result;
      if (isSupportedLanguageModel(model)) {
...
var PromptInjectionDetector = class _PromptInjectionDetector {
  ...
  async detectPromptInjection(content, observabilityContext) {
    ...
    try {
      ...
      const baseSchema = z9__default.default.object({
        categories: z9__default.default.array(
          z9__default.default.object({
            type: z9__default.default.enum(this.detectionTypes).describe("The type of attack detected from the list of detection types"),
            score: z9__default.default.number().min(0).max(1).describe("Confidence level between 0 and 1 indicating how certain the detection is")
          })
        ).nullable(),
        reason: z9__default.default.string().describe("The reason for the detection").nullable()
      });
      let schema = baseSchema;
      if (this.strategy === "rewrite") {
        schema = baseSchema.extend({
          rewritten_content: z9__default.default.string().describe("The rewritten content that neutralizes the attack while preserving any legitimate user intent").nullable()
        });
      }
      let result;
      if (isSupportedLanguageModel(model)) {
...
var PIIDetector = class _PIIDetector {
  ...
  async detectPII(content, observabilityContext) {
    ...
    try {
      const model = await this.detectionAgent.getModel();
      const baseDetectionSchema = z9__default.default.object({
        type: z9__default.default.string().describe("Type of PII detected"),
        value: z9__default.default.string().describe("The actual PII value found"),
        confidence: z9__default.default.number().min(0).max(1).describe("Confidence of this detection"),
        start: z9__default.default.number().describe("Start position in the text"),
        end: z9__default.default.number().describe("End position in the text")
      });
      const detectionSchema = this.strategy === "redact" ? baseDetectionSchema.extend({
        redacted_value: z9__default.default.string().describe("Redacted version of the value").nullable()
      }) : baseDetectionSchema;
      const baseSchema = z9__default.default.object({
        categories: z9__default.default.array(
          z9__default.default.object({
            type: z9__default.default.enum(this.detectionTypes).describe("The type of PII detected from the list of detection types"),
            score: z9__default.default.number().min(0).max(1).describe("Confidence level between 0 and 1 indicating how certain the detection is")
          })
        ).describe("Array of detected PII types with their confidence scores").nullable(),
        detections: z9__default.default.array(detectionSchema).describe("Array of specific PII detections with locations").nullable()
      });
      const schema = this.strategy === "redact" ? baseSchema.extend({
        redacted_content: z9__default.default.string().describe("The content with all PII redacted according to the redaction method").nullable()
      }) : baseSchema;
      let result;
      if (isSupportedLanguageModel(model)) {
        const response = await this.detectionAgent.generate(prompt, {
...
var LanguageDetector = class _LanguageDetector {
  ...
  async detectLanguage(content, observabilityContext) {
    ...
    try {
      const model = await this.detectionAgent.getModel();
      const baseSchema = z9__default.default.object({
        iso_code: z9__default.default.string().describe("ISO language code").nullable(),
        confidence: z9__default.default.number().min(0).max(1).describe("Detection confidence").nullable()
      });
      const schema = this.strategy === "translate" ? baseSchema.extend({
        translated_text: z9__default.default.string().describe("Translated text").nullable()
      }) : baseSchema;
      let result;
      if (isSupportedLanguageModel(model)) {
        const response = await this.detectionAgent.generate(prompt, {
        ...
        const response = await this.detectionAgent.generateLegacy(prompt, {
          output: chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(schema),
          temperature: 0,
          providerOptions: this.providerOptions,
          ...observabilityContext
        });
...
// src/processors/processors/token-limiter.ts
var TokenLimiterProcessor = class _TokenLimiterProcessor {
  ...
  getEncoder() {
    if (!this.encoderPromise) {
      if (this.customEncoding) {
        ...
        this.encoderPromise = chunkCTFO2ENI_cjs.getTiktoken();
      }
    }
   ...
   */
  async countCoreSystemMessageTokens(message) {
    if (message.role !== "system") {
      throw new Error(
    ...
    return encoder.encode(tokenString).length + _TokenLimiterProcessor.TOKENS_PER_MESSAGE;
  }
  /**
   * Count tokens for an input message, including overhead for message structure
   */
  async countInputMessageTokens(message) {
    const encoder = await this.getEncoder();
...
var SystemPromptScrubber = class {
  ...
  async detectSystemPrompts(text, observabilityContext) {
    try {
      const model = await this.detectionAgent.getModel();
      const baseDetectionSchema = z9.z.object({
        type: z9.z.string().describe("Type of system prompt detected"),
        value: z9.z.string().describe("The detected content"),
        confidence: z9.z.number().min(0).max(1).describe("Confidence score"),
        start: z9.z.number().describe("Start position in text"),
        end: z9.z.number().describe("End position in text")
      });
      const detectionSchema = this.strategy === "redact" ? baseDetectionSchema.extend({
        redacted_value: z9.z.string().describe("Redacted value if available").nullable()
      }) : baseDetectionSchema;
      const baseSchema = z9.z.object({
        detections: z9.z.array(detectionSchema).describe("Array of system prompt detections").nullable(),
        reason: z9.z.string().describe("Reason for detection").nullable()
      });
      const schema = this.strategy === "redact" ? baseSchema.extend({
        redacted_content: z9.z.string().describe("Redacted content").nullable()
      }) : baseSchema;
      let result;
      if (isSupportedLanguageModel(model)) {
...
var ToolSearchProcessor = class {
  ...
  constructor(options) {
    ...
    this.bm25Index = new chunkCTFO2ENI_cjs.BM25Index({}, TOOL_SEARCH_TOKENIZE_OPTIONS);
    this.indexTools();
    if (this.ttl > 0) {
  ...
  async processInputStep(args) {
    ...
    const searchTool = chunkNQXA2BUF_cjs.createTool({
      id: "search_tools",
      ...
      inputSchema: z9.z.object({
        query: z9.z.string().describe('Search keywords (e.g., "weather", "github issue", "database query")')
      }),
      outputSchema: z9.z.object({
        results: z9.z.array(
          z9.z.object({
            name: z9.z.string(),
            description: z9.z.string(),
            score: z9.z.number()
          })
        ),
        message: z9.z.string()
    ...
    const loadTool = chunkNQXA2BUF_cjs.createTool({
      id: "load_tool",
      ...
      inputSchema: z9.z.object({
        toolName: z9.z.string().describe("The exact name of the tool to load (from search results)")
      }),
      outputSchema: z9.z.object({
        success: z9.z.boolean(),
        message: z9.z.string(),
        toolName: z9.z.string().optional()
      }),
...
`;
  ...
  generateEmptyFromSchemaInternal(schema) {
    const result = chunkYVFFNB2F_cjs.generateEmptyFromSchema(schema);
...
var SemanticRecall = class {
  ...
  formatCrossThreadMessages(messages, currentThreadId) {
    let result = ``;
    const v1Messages = new chunkO6O5MD7Q_cjs.MessageList().add(messages, "memory").get.all.v1();
    let lastYmd = null;
...
https://mastra.ai/en/docs/memory/semantic-recall`
      ...
      if (typeof config.embedder === "string") {
        this.embedder = new chunkP2PWEGRW_cjs.ModelRouterEmbeddingModel(config.embedder);
      } else {
...
https://mastra.ai/en/docs/memory/overview`
  ...
  setEmbedder(embedder, embedderOptions) {
    if (typeof embedder === "string") {
      this.embedder = new chunkP2PWEGRW_cjs.ModelRouterEmbeddingModel(embedder);
    } else {
  ...
  getMergedThreadConfig(config) {
    ...
    const mergedConfig = chunkYVFFNB2F_cjs.deepMerge(this.threadConfig, config || {});
...
var MockMemory = class extends MastraMemory {
  constructor({
    ...
    super({
      name: "mock",
      storage: storage || new chunkVSGRSX3N_cjs.InMemoryStore(),
      options: {
        ...options,
  ...
  listTools(_config) {
    ...
    return {
      updateWorkingMemory: chunkNQXA2BUF_cjs.createTool({
        id: "update-working-memory",
        description: `Update the working memory with new information. Any data not included will be overwritten.`,
        inputSchema: z9__default.default.object({ memory: z9__default.default.string() }),
        execute: async (inputData, context) => {
  ...
  async getWorkingMemoryTemplate({
    ...
    if (workingMemoryConfig.schema) {
      try {
        ...
        let convertedSchema;
        convertedSchema = chunkVWJ7H3MJ_cjs.standardSchemaToJSONSchema(chunkVWJ7H3MJ_cjs.toStandardSchema(schema));
...
exports.forwardAgentStreamChunk = forwardAgentStreamChunk;
...
//# sourceMappingURL=chunk-BXSSIONK.cjs.map
//# sourceMappingURL=chunk-BXSSIONK.cjs.map